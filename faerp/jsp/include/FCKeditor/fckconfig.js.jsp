...
FCKConfig.ToolbarSets["Default"] = [
	['Source','DocProps','-','Preview','-','Templates'],  //'Save','NewPage',
...
FCKConfig.LinkUploadURL = '<%=request.getContextPath()%>/jsp/include/FCKeditor/editor/upload4Fck.jsp';
FCKConfig.LinkUploadAllowedExtensions	= "" ;			// empty for all
FCKConfig.LinkUploadDeniedExtensions	= ".(php|php3|php5|phtml|asp|aspx|ascx|jsp|cfm|cfc|pl|bat|exe|dll|reg|cgi)$" ;	// empty for no one

FCKConfig.ImageUpload = true ;
FCKConfig.ImageUploadURL = '<%=request.getContextPath()%>/jsp/include/FCKeditor/editor/upload4Fck.jsp';
FCKConfig.ImageUploadAllowedExtensions	= ".(jpg|gif|jpeg|png)$" ;		// empty for all
FCKConfig.ImageUploadDeniedExtensions	= "" ;							// empty for no one

FCKConfig.FlashUpload = true ;
FCKConfig.FlashUploadURL = '<%=request.getContextPath()%>/jsp/include/FCKeditor/editor/upload4Fck.jsp';
