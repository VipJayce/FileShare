...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		<tr>
			<td class="td_1" >partytype_id：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getPartytype_id())%></td>
		</tr>
		<tr>
			<td class="td_1" >partytype_keyword：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getPartytype_keyword())%></td>
		</tr>
		<tr>
			<td class="td_1" >is_inherit：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getIs_inherit())%></td>
		</tr>
		<tr>
			<td class="td_1" >is_real：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getIs_real())%></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getOwner_org())%></td>
		</tr>
		<tr>
			<td class="td_1" >备注：</td>
		...
		<tr>
			<td class="td_1" >启用/禁用状态：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getEnable_status())%></td>
		</tr>
		<tr>
			<td class="td_1" >启用/禁用日期：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getEnable_date(), 10)%></td>
		</tr>
		<tr>
