...
function getAllBigType(selectObject,key,value,selectvalue){
    ...
    function simpleQuery_onClick(){  //简单的模糊查询
        ...
        form.action="<%=request.getContextPath()%>/ProductAction.do?cmd=queryByProduct&big_type_id="+big_type_id+"&date="+new Date();
        form.submit();
    }
</script>
</head>
...
<input type="hidden" name="cmd" value="queryByProduct">
 
 
<div id="right">
<script language="javascript">
	writeTableTopFesco('<fmt:message key="referto_page"/>','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
            <td width="275" rowspan="3" style="padding-top:0;"><div class="search_title">查询条件</div> </td>
            <td width="186"/>
            <td width="156"/>
              <td width="414"></td>
              <td width="135">    </td>
        ...
        <tr>
            ...
            <td align="left">
              ...
              </div></td><td align="right">产品名称</td>
            <td colspan="3" align="left"><input type="text" class="text_field" name="product_name" inputName="产品名称" maxLength="20" value="<%=productname%>"/>            </td>
            </tr>
        
        <tr>
              <td align="right">&nbsp;</td>
              <td align="left">&nbsp;</td>
              <td align="right"><input name="button_ok222" class="icon_1"   type="button" value='<fmt:message key="query"/>' onClick="javascript:simpleQuery_onClick()">
&nbsp;
<input name="button_reset222" class="icon_1" type="button" value='<fmt:message key="reset"/>' onClick="javascript:this.form.reset()"></td>
...
<th>
			  	...
			  	<a href="/FAERP/ProductAction.do?cmd=queryByProduct&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"product_name")%>">
			...
			<th>
					...
					<a href="/FAERP/ProductAction.do?cmd=queryByProduct&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"big_type_id")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"big_type_id")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"big_type_id")%>">           	</a>	
       
	 产品大类</th>
     	<th>
					
					<a href="/FAERP/ProductAction.do?cmd=queryByProduct&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"small_type_id")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"small_type_id")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"small_type_id")%>">           	</a>	
       
	 产品小类</th>
     	<th>
					
					<a href="/FAERP/ProductAction.do?cmd=queryByProduct&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"three_type_id")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"three_type_id")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"three_type_id")%>">           	</a>	
