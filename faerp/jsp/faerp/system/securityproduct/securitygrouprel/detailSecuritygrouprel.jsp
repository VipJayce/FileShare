...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			...
			<td class="td_2"><%=gap.rm.project.RmGlobalReference.get(ISecuritygrouprelConstants.DICTIONARY_, resultVo.getMonth_pay_bd())%></td>
		</tr>
		<tr>
			<td class="td_1" >是否可补收：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getIs_supply())%></td>
		</tr>
		<tr>
