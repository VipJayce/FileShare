...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getFin_invoice_template_id())%></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getFin_big_subjects_bd())%></td>
		</tr>
		<tr>
			<td class="td_1" >fin_small_subjects_bd：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getFin_small_subjects_bd())%></td>
		</tr>
		<tr>
