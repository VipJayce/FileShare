...
<script language="javascript">
    ...
    function onKey_Up(v_str) {
        ...
        var url="<%=request.getContextPath()%>/Fin_invoice_templateAction.do?cmd=checkTemplateName&template_name=" + v_str+"&id=${bean.id}";
            ...
            if(data){
                    if(data!=""){
	                        if(data == '1'){
	                              ...
	                              $id("template_name").value="${bean.template_name}";
...
<div class="xz_title" style="padding-top: 5px">修改模板</div>
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		<tr>
			<td  class="td_1" ><span class="style_required_red">* </span>模板名称</td>
			<td  class="td_2 "><input type="text" class="sText" value="${bean.template_name}" name="template_name" id="template_name" onblur="onKey_Up(this.value)"/></td>
			<td  class="td_1" >创建人</td>
			<td  class="td_2" ><input type="text" class="sText"  readonly="true" value="<%=LoginHelper.getLoginName(request)%>"  name="username"/><input type="hidden" class="sText" value="${bean.create_user_id}" name="create_user_id"/> </td>
		</tr>
	<!--	<tr>
		...
		<tr>
            ...
            <td class="td_2 " colspan="4">
                <textarea id="template_remark" style="width:400px; height:40px;" class="xText_d" rows="4" name="template_remark">${bean.template_remark}</textarea>
            </td>
        </tr>
	</table>
