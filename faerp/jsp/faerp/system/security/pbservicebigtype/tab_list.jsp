 ...
 <script  language="javascript">
    var tabs;
     function updateData() { //定义修改状态时显示的标签页
        tabs  =  new Array(
            new Array ("员工分类维护","<%=request.getContextPath()%>/PbservicebigtypeAction.do?cmd=queryAll"),
            new Array ("服务项目维护","<%=request.getContextPath()%>/PbserviceAction.do?cmd=queryAll"),
            new Array ("分类-服务关联","<%=request.getContextPath()%>/PbServiceSmallTypeAction.do?cmd=queryAll")
        );
...
<div id="right">
    <!--<div class="right_title_bg">
      <div class=" right_title">入职基础信息维护</div>
    </div>-->
<div>
