...
<script language="javascript">
    ...
    function onKey_Up(v_str) {
        ...
        var url="<%=request.getContextPath()%>/FIN_INVOICE_CODEAction.do?cmd=checkSubjectsName&subjects_name=" + v_str;
...
<div class="xz_title" style="padding-top: 5px">新增code</div>
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
            ...
            <r:comboSelect id="fin_subjects_bd" name="fin_subjects_bd" queryAction="/FAERP/FIN_INVOICE_CODEAction.do?cmd=getFinSubjectsListData&dd_base=FIN_SUBJECTS_BD"
                       textField="name" valueField="code" xpath="DDBasedataVO" width="190px" nullText="--请选择--" />    
            </td>
            <td  class="td_1" ><span class="style_required_red">* </span>账期</td>
            <td  class="td_2" ><input type="text" class="sText"  value=""  name="bill_year_month" id="bill_year_month"/></td>
        </tr>
		<tr>
			<td  class="td_1" ><span class="style_required_red">* </span>项目名称</td>
			<td  class="td_2 "><input type="text" class="sText" value="" name="subjects_name" id="subjects_name" onblur="onKey_Up(this.value)"/></td>
			<td  class="td_1" >项目代码</td>
			<td  class="td_2" ><input type="text" class="sText"  value=""  name="subjects_code" id="subjects_code" readonly="readonly"/>
