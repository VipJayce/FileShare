...
<%@ page import="rayoo.system.serviceitem.vo.ServiceitemVo" %>
<%@ page import="rayoo.system.serviceitem.util.IServiceitemConstants" %>
<%  //取出本条记录
	ServiceitemVo resultVo = null;  //定义一个临时的vo变量
	resultVo = (ServiceitemVo)request.getAttribute(IServiceitemConstants.REQUEST_BEAN);  //从request中取出vo, 赋值给resultVo
...
<script language="javascript">
    function back_onClick(){  //返回列表页面
        form.action="<%=request.getContextPath()%>/ServiceitemAction.do?cmd=queryAll&backFlag=true";
        form.submit();
    }
</script>
</head>
...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			<td class="td_1" >post_belong：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getPost_belong())%></td>
		</tr>
		<tr>
			<td class="td_1" >备注：</td>
		...
		<tr>
			<td class="td_1" >last_update_name：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getLast_update_name())%></td>
		</tr>
		<tr>
