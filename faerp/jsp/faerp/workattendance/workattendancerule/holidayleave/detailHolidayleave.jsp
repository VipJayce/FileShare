...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		<tr>
			<td align="right" width="10%" nowrap>调班日期：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getTransdate())%></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right" width="10%" nowrap>主表ID：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getFzqxjb_id())%></td>
		</tr>
		<tr>
