...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		<tr>
			...
			<td align="left"><%=RmStringHelper.prt(resultVo.getKsto())%></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="left"><%=RmStringHelper.prt(resultVo.getJsto())%></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right" width="10%" nowrap>作息时间ID：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getPk_wtid())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>人员工作日历主键：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getPk_psncalendar())%></td>
		</tr>
		<tr>
