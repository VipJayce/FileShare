...
<%  //判断是否为修改页面
	...
	if(request.getParameter("isModify") != null) {  //如果从request获得参数"isModify"不为空
		...
		if(request.getAttribute(ISpmonthstaterrordataConstants.REQUEST_BEAN) != null) {  //如果request中取出的bean不为空
  		    resultVo = (SpmonthstaterrordataVo)request.getAttribute(ISpmonthstaterrordataConstants.REQUEST_BEAN);  //从request中取出vo, 赋值给resultVo
  		}
	}
%>
<html>
...
<script language="javascript">
	function insert_onClick(){  //插入单条数据
		form.action="<%=request.getContextPath()%>/SpmonthstaterrordataAction.do?cmd=insert";
		form.submit();
	}
  	...
  	function update_onClick(id){  //保存修改后的单条数据
	    ...
	    form.action="<%=request.getContextPath()%>/SpmonthstaterrordataAction.do?cmd=update";
    	form.submit();
	}

    function cancel_onClick(){  //取消后返回列表页面
        form.action="<%=request.getContextPath()%>/SpmonthstaterrordataAction.do?cmd=queryAll&backFlag=true";
        form.submit();
    }
</script>
</head>
...
<tr><td> 
	<table class="table_div_content_inner">
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="errorrow" inputName="errorrow" value="" maxLength="4" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="errorcell" inputName="errorcell" value="" maxLength="4" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="errormsg" inputName="errormsg" value="" maxLength="200" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="is_valid" inputName="is_valid" value="" maxLength="1" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="period_id" inputName="period_id" value="" maxLength="9.5" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
