...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		<tr>
			<td align="right" width="10%" nowrap>errorrow：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getErrorrow())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>errorcell：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getErrorcell())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>errormsg：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getErrormsg())%></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right" width="10%" nowrap>period_id：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getPeriod_id())%></td>
		</tr>
		<tr>
			<td align="right"></td>
			<td align="left"></td>
