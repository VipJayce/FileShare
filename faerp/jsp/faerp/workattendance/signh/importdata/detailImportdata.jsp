...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		<tr>
			<td align="right" width="10%" nowrap>刷卡状态（签到、签退标志）：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getDatastatus())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>日历时间(签卡时间)：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getCalendartime(), 10)%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>考勤卡号：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getTimecardid())%></td>
		</tr>
		<tr>
