...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
     ...
     function choose()
    {
        ...
        returnAry[7]=entity.getProperty("warrantyperiod");
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td align="left"><input type="text" class="text_field"
				id="contract_code" name="contract_code" inputName="合同编号" maxLength="64" /></td>
...
<r:datacell 
        id="datacell1"
       queryAction="/FAERP/SalcontractAction.do?cmd=searchSalcontractData&f=zp&contract_status_bd=4"
