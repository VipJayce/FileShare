...
<r:datacell id="datacell1"
            queryAction="/FAERP/ProductAction.do?cmd=simpleQueryVoucher&big_type_id=${param.bigtypeid}&cust_id=${requestScope.cust_id}" 
            isCount="false"
            width="100%" 
            xpath="ProductVo" 
            readonly="true"
            ...
            -->  
             <r:field fieldName="product_price" width="90px" label=" 标准价格"  >
               ...
               <r:field fieldName="product_simple_desc" width="200px" label=" 产品描述"  >
            </r:field>
        </r:datacell>
</div>
</div>
