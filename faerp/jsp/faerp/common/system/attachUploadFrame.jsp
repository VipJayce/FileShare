...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
  <tr height="40%" id="tr_uploadContent">
    <td align="center" cellSpacing="1">
		<iframe name="uploadContent" src="attachUpload.jsp?uploadDir=<%=uploadDir%>" onLoad="window.setTimeout('uploadHandler.refreshInfo()',500);"  frameBorder="0" border="0" width="100%" height="100%">
		</iframe>
	</td>
  </tr>
</table>
