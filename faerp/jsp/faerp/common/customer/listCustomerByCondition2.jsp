...
String agent_id = request.getAttribute("agent_id")==null?"":request.getAttribute("agent_id").toString();
%>
...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
    ...
    <div class="clear"></div>
         ...
         <div  id="div1" style="margin:5 0 0 10px;">
                            <r:datacell 
                            queryAction="/FAERP/CustomersimpleAction.do?cmd=getCustomerList2"
                            id="celllist1"
