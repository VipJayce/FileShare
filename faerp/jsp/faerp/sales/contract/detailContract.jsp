...
<script language="javascript">
    ...
    //    form.action="<%=request.getContextPath()%>/ContractAction.do?cmd=insert";
  //      form.submit();
    ...
    var id = document.getElementById("ids").value;
      ...
      if(contract_template_version==""||contract_template_version.trim().length==0){
           alert("<fmt:message key='contract_template_version_not_null'/>");
           return ;
        }
    
          if(effect_date==""||effect_date.trim().length==0){
           alert("<fmt:message key='effect_date_not_null'/>");
           return ;
        }
        
           if(lapse_date==""||lapse_date.trim().length==0){
           alert("<fmt:message key='lapse_date_not_null'/>");
           return ;
        }
    ...
    if(null != id &&id.trim().length != 0){
          jQuery.ajax({
        url: "<%=request.getContextPath()%>/ContractAction.do?cmd=update&contract_template_name="+contract_template_name+"&contract_template_version="+contract_template_version+"&effect_date="+effect_date+"&lapse_date="+lapse_date+"&id="+id,
        type: 'GET',
        dataType: 'html',
        timeout: 10000,
        error: function(){
        ...
        alert("<fmt:message key='renewal_success'/>");  
          ...
          jQuery.ajax({
        url: "<%=request.getContextPath()%>/ContractAction.do?cmd=insert&contract_template_name="+contract_template_name+"&contract_template_version="+contract_template_version+"&effect_date="+effect_date+"&lapse_date="+lapse_date,
        type: 'GET',
        dataType: 'html',
        timeout: 10000,
        error: function(){
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
            ...
            <td class="td_2 ">
                <input type="text" class="text_field"  id = "contract_template_name"  readonly="readonly"  name="contract_template_name" inputName="合同模板名称"  value="<% out.print(contract_template_name); %>"    maxLength="50" validate="notNull;"/>
            </td>
             <td class="td_1" ><fmt:message key='contract_template_version'/></td>
            <td class="td_2 ">
                <input type="text" class="text_field" id="contract_template_version"  readonly="readonly"   name="contract_template_version" inputName="合同模板版本号"value="<% out.print(contract_template_version);%>"    maxLength="64" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="td_2">
                <w:date format="yyyy-MM-dd" id="effect_date" name="effect_date" readOnly="true" property="bean/effect_date" width="189px"/>
            </td>
             <td class="td_1" ><fmt:message key='contract_lapse_date'/></td>
            <td class="td_2">
                <w:date format="yyyy-MM-dd" id="lapse_date" name="lapse_date" readOnly="true" property="bean/lapse_date" width="189px"/>
            </td>
        </tr>
...
<tr>
    ...
    <tr>
        <td valign="top">
                <div id="tree" style="width:350; height:350;overflow:auto;">
            </div><br>
        </td>
