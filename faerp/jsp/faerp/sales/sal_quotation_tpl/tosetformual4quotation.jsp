...
<%@page import="rayoo.sales.sal_quotation_tpl.util.ExcuteFormulaForSalQuotationUtils"%>
    ...
    <td width="50%">
     ...
     <div class="zbox" style="float:left;">
        ...
        <% if(fromTpl){ %>
	        ...
	        <input type="hidden" id="sal_quotation_tpl_sc_id" name="sal_quotation_tpl_sc_id" value="${param.sc_id }">
	        </form>
	          <r:datacell id="datacell_sc_item" 
	              width="98%"
	            queryAction="/FAERP/Sal_quotation_tpl_sc_itemAction.do?cmd=queryForDatacell" height="160px"
	          ...
	          <r:field fieldName="name" messagekey="name" width="100px" ></r:field>    
	          <r:field fieldName="code" messagekey="code" width="100px" ></r:field>    
	          <r:field fieldName="formula" messagekey="formula" width="300px" ></r:field>
	          <r:field fieldName="remark" messagekey="remark" width="100px" ></r:field>    
	          </r:datacell>
		  <%} else {%>
          
                <form action="" id="sc_item_form" method="post">
	            <input type="hidden" id="sal_quotation_sc_id" name="sal_quotation_sc_id" value="${param.sc_id }">
	            </form>
	              <r:datacell id="datacell_sc_item" 
		            queryAction="/FAERP/Sal_quotation_sc_itemAction.do?cmd=queryForDatacell" width="100%" height="160px"
  ...
  <tr>
    <td>
	  ...
	  <% if(fromTpl){ %>
            ...
            <input type="hidden" id="sal_quotation_tpl_id" name="sal_quotation_tpl_id" value="${param.tpl_id }">
            
            </form>
	        
	        
	          <r:datacell id="datacell_para" 
            queryAction="/FAERP/Sal_quotation_tpl_paraAction.do?cmd=queryForDatacell" width="98%" height="100px"
          ...
          <r:field fieldName="name" messagekey="name" width="100px" ></r:field>    
          <r:field fieldName="code" messagekey="code" width="100px" ></r:field>    
          <r:field fieldName="default_value" messagekey="default_value" width="100px" ></r:field>    
          <r:field fieldName="remark" messagekey="remark" width="100px" ></r:field>    
          ...
          <%} else {%>
	            ...
	            <input type="hidden" id="sal_quotation_id" name="sal_quotation_id" value="${param.sal_quotation_id }">
	            </form>
	            
	            
	              <r:datacell id="datacell_para" 
		            queryAction="/FAERP/Sal_quotation_sc_paraAction.do?cmd=queryForDatacell" width="98%" height="100px"
...
<script language="javascript">
    ...
    function initUtilsMethodDatacell(){
        ...
        var data = [
        <%
        Set<String> methods = ExcuteFormulaForSalQuotationUtils.EXCUTE_FORMULA_FOR_SALQUOTATION_UTILS_MHTHOD.keySet();
    ...
    $id("datacell_sc_item").onDblClickRow  = function(rowTR,rowIndex,entity,datacell){
        var value=entity.getProperty("code");//取得薪资项ID
        addText(''+value+'');
    } 
