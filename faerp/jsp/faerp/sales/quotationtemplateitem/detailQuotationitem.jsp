...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		<tr>
			<td class="td_1" >报价单模板信息ID：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getSal_id())%></td>
		</tr>
		<tr>
			<td class="td_1" >报价单模板ID：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getQuotation_template_id())%></td>
		</tr>
		<tr>
