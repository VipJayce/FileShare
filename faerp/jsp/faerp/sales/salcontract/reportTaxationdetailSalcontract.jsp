...
<title><fmt:message key="not_title_word"/></title>
 ...
 updateData(); 
    ...
    function appOperate_onClick(){        
     ...
     //   alert('审批操作'+message);
      //  form.action="<venus:base/>/reportTaxationlWorkFlowAction.do?cmd=appOperate&message="+message[0]+"&taskuid=<%=taskuid%>";
      
      form.action="<venus:base/>/reportTaxationlWorkFlowAction.do?message="+message[0];
