...
<title><fmt:message key="not_title_word"/></title>
 ...
 updateData(); 
    ...
    function appOperate_onClick(){        
     ...
     //   alert('审批操作'+message);
      //  form.action="<venus:base/>/wfattdetailSalcontract.do?cmd=appOperate&message="+message[0]+"&taskuid=<%=taskuid%>";
      
      form.action="<venus:base/>/salcontratcAttnAction.do?message="+message[0];
