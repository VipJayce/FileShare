...
<title><fmt:message key="not_title_word"/></title>
 ...
 updateData(); 
   ...
   //     alert('审批操作'+message);
      //  form.action="<venus:base/>/agentBillWorkFlowAction.do?cmd=appOperate&message="+message[0]+"&taskuid=<%=taskuid%>";
      
      form.action="<venus:base/>/agentBillWorkFlowAction.do?message="+message[0];
