...
<table class="table_noFrame" >
    <tr>
      ...
      <%    if("1".equals(create_type_bd)){
           %>
          <input type="<%=isModify?"button":"hidden"%>" class="button_ellipse" value='预览'  onClick="javascript:yulan_onClick()"/>
          ...
          <tr>
             ...
             <tr>
               ...
               <input type="text" class="text_field"  id="warrantyperiod"  name="warrantyperiod" inputName="担保期限" value="${bean.warrantyperiod }" maxLength="50" validate="notNull;"/>
                   <%}else{ %>
                    <input type="text" class="text_field"  id="warrantyperiod"  name="warrantyperiod" inputName="担保期限" value="${bean.warrantyperiod }" maxLength="50" validate="notNull;" readonly="readonly"/>
                     <%} %>
               </td>
