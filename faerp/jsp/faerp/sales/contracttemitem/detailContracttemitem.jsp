...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		<tr>
			<td class="td_1" >表SAL_CONTRACT_TEMPLATE 的ID：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getContract_template_id())%></td>
		</tr>
		<tr>
			<td class="td_1" >合同模板明细名称：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getContract_template_item_name())%></td>
		</tr>
		<tr>
			<td class="td_1" >合同模板明细内容：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getContract_template_item_content())%></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="td_1" >是否可以更改：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getIs_can_modify())%></td>
		</tr>
		<tr>
