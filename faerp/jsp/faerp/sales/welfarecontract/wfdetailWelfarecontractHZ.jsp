...
<script>
    ...
    function backTask_onClick() { //返回到列表页面
        form.action = "<%=request.getContextPath()%>/dynamicQueryTaskByPersonIDAction.do";
        form.submit();
    }
                    ...
                    <div id="ccChild1"     class="box_xinzeng"> 
                        ...
                        <c:if test="${done=='true'}">
			                    <div class="foot_button">
		                            <input name="button_back" class="foot_icon_1" type="button" value="<fmt:message key="go_back"/>"  onclick="javascript:backTask_onClick();" >
		                        </div>
			            </c:if>
			            <c:if test="${done=='false'}">
			                  <div class="foot_button">
		                            <input name="button_back" class="foot_icon_1" type="button" value="<fmt:message key="go_back"/>"  onclick="javascript:backTask_onClick();" >
		                            <input name="button_app" class="foot_icon_1" type="button" value="<fmt:message key="agree"/>"  onclick="javascript:appOperate_onClick();" >
		                            <input name="button_back" class="foot_icon_1"  type="button" value="<fmt:message key="reject"/>"  onclick="javascript:backOperate_onClick();" >
		                      </div>
			            </c:if>
                    </div>     
                </div>
