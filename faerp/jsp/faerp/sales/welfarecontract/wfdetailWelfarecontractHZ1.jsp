    ...
    function appOperate_onClick(){        
     ...
     if(contract_start_date==""&&contract_start_date.length==0){
      ...
      if(contract_stop_date!=""&&contract_stop_date.length!=0){
          ...
          form.action="<%=request.getContextPath()%>/SalcontractAction.do?cmd=appOperateHZ1&custaname="+custaname+"&custaid="+custaid+"&arrach_name="+arrach_name+"&attack_address="+attack_address+"&contract_stop_date="+contract_stop_date+"&agentbid="+agentbid+"&contract_start_date="+contract_start_date+"&con="+con+"&message="+message[0];
        ...
        <tr>
            <td>
			    ...
			    <c:if test="${done=='false'}">
		                <input name="button_back" class="button_ellipse" type="button" value="<fmt:message key="go_back"/>" onclick="javascript:backTask_onClick();">
		                <input name="button_app" class="button_ellipse" type="button" value="<fmt:message key="submitted_for_approval"/>" onclick="javascript:appOperate_onClick();">
		                <input name="button_back" class="button_ellipse" type="button" value="<fmt:message key="revoke"/>" onclick="javascript:cancelOperate_onClick();">
			    </c:if>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" height="40" border="0" cellpadding="0"
        ...
        <tr>
            ...
            <td class="td_2" nowrap="nowrap"><input type="hidden"
                ...
                value="<%=contract_type_bd %>"> <%=gap.rm.tools.helper.RmJspHelper.getSelectField("contract_type_bd", -1, "CONTRACT_TYPE_BD", contract_type_bd, " id=contract_type_bd  dis   disabled='disabled'     ", false)%>
            </td>
        ...
        <tr>
			...
			<td class="td_2 " nowrap="nowrap">
                <w:lookup
                    ...
                    messagekey="choose_contract_yifang" height="500" width="710" />
                    <input type="hidden" name="agent_b_id" id="agent_b_id" value="<%=agent_b_id %>" />
                    <input type="hidden" name="agent_b_name" id="agent_b_name" />
            </td>
		</tr>
