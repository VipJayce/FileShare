...
<fmt:bundle basename="rayoo.salse.sp_risk_fund.sp_risk_fund_resource" prefix="rayoo.salse.sp_risk_fund.">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <div class="search_title"><fmt:message key="query_conditions"/></div>            </td>
        </tr>
        <tr>
            <td width="166" align="left"><fmt:message key="customer_code"/></td>
    ...
    <div class="clear"></div>
         ...
         <div  id="div1" style="margin:5 0 0 10px;">
                            <r:datacell 
                            queryAction="/FAERP/Sp_risk_fund_expAction.do?cmd=getCustomerList"
                            id="celllist1"
                          ...
                          <r:field fieldName="customer_name" messagekey="customer_name" width="300px">
                          <h:text />
                          </r:field>
                        </r:datacell>
            </div>
