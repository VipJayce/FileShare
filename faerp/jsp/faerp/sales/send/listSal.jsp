...
<title><fmt:message key="query_contract"/></title>
...
<div id="bg" class="xixi1">
            <div id="font1" class="tab1" onmousedown="setTab03Syn(1);document.getElementById('bg').className='xixi1'"><fmt:message key="contract_basic_info"/></div>
                 ...
                 <div id="font2" class="tab2" onmousedown="setTab03Syn(2);"><fmt:message key="item_info"/></div>
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
            ...
            <td class="td_2 " nowrap="nowrap">
                ...
                <input type="text" readonly="readonly" class="text_field"  id="contract_name"  name="contract_name" inputName="合同名称" value=" <% if(null!=contract_name&&!"".equals(contract_name))   out.print(contract_name);   %>  " maxLength="50" validate="notNull;"/>
            </td>
        </tr>
    
        <tr>
            <td class="td_1" ><span class="style_required_red">* </span><fmt:message key="contract_jia"/></td>
            <td class="td_2 " nowrap="nowrap">
            ...
            <td class="td_1" ><span class="style_required_red">* </span><fmt:message key="contract_yi"/></td>
            <td class="td_2 " nowrap="nowrap">
        ...
        %>
            <td class="td_1" ><fmt:message key="contract_attachment_id"/></td>
            <td class="td_2 "  colspan="2"  >
