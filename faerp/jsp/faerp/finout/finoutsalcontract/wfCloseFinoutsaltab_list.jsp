...
<script language="javascript">
    ...
    function appOperate_onClick(){        
      ...
      form.action="<venus:base/>/Finout_contract_productAction.do?message="+message[0]+"&_ts="+(new Date()).getTime();
           document.getElementById("cmd").value="appOperatetoColse";
    ...
    function backOperate_onClick(){
        ...
        document.getElementById("cmd").value="appOperateDonotColse";
        form.submit();
...
<script type="text/javascript">
writeTableTopFesco('合同关闭审批','<%=request.getContextPath()%>/');
</script>
...
<table class="table_noFrame"  align="center">
    <tr>
        ...
        <input name="button_app" class="icon_2" type="button" value="同意关闭"  onclick="javascript:appOperate_onClick();" >
        <input name="button_back" class="icon_2" type="button" value="不同意"  onclick="javascript:backOperate_onClick();" >
        </td>
    </tr>
</table>
</form>
