...
<script type="text/javascript">
 ...
 function appOperate_onClick(){  //保存修改后的单条数据
      ...
      if(contract_stop_date!=""&&contract_stop_date.length!=0){
            ...
            <%if(create_type_bd!=null&&!create_type_bd.trim().equals("2")){%>
                ...
                <%}%>
                  ...
                  if(message==null)return;
                 var action="<%=request.getContextPath()%>/Finout_contract_productAction.do?cmd=appOperate1&message="+message[0]+"&_ts="+(new Date()).getTime();
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
            ...
            <td class="td_2 " nowrap="nowrap">
               <w:lookup onReturnFunc="rtnFunc" lookupWidth="189px" readonly="false"             disabled="${create_type_bd==1?'true':'false'}"                 displayValue="<%=customer_name %>" id="lk_cust" lookupUrl="/CustomersimpleAction.do?cmd=getAllCustomerByCondition1" dialogTitle="选择合同甲方" height="440" width="710"/>
...
<input  type="hidden"  value="<%=taskuid%>" name="taskuid" id="taskuid"  >
 <div class="mx_button" align="center">
        ...
        <input name="button_app" class="icon_2" type="button" value="重新提交审批"  onclick="javascript:appOperate_onClick();" >
        <input name="button_back" class="icon_2" type="button" value="取消审批"  onclick="javascript:backOperate_onClick();" >
</div>
<!-- 
