...
<script language="javascript">
    ...
    function showListData(){
		...
		var current_user_id = form.current_user_id.value;
		var emp_id = form.empname.value;
		//alert(emp_id);
        ...
        var url = "<%=request.getContextPath()%>/jsp/faerp/reportJsp/showFinoutReportForXLS.jsp?reportFileName=finout_invoice_report.raq" + 
    	"&date_s=" + create_date_s + "&date_e=" + create_date_e + 
    	"&current_user_id=" + current_user_id + "&emp_id=" + emp_id;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
        ...
        <tr>
            ...
            <td align="left">
            	<input type="hidden" id="current_user_id" value="<%=UserInfoFilter.getLoginUserId() %>"/>
	            	<r:comboSelect id="empname" name="empname"
	               queryAction="/FAERP/PbcustomerserviceAction.do?cmd=getEmpForMangedUsers"
	                textField="name"
	                valueField="partyid"
	                xpath="Partyrelation"
