...
<script language="javascript">
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
		...
		if(ids.length > 1) {  //如果ids有2条以上的纪录
           ...
           var isExiseurl="<%=request.getContextPath()%>/AgentEmpSendPostAction.do?cmd=find2&id=" + ids;
    jQuery.post(isExiseurl,function(data){
             if(data){
                if(data==0){
               var url="<%=request.getContextPath()%>/AgentEmpSendPostAction.do?cmd=find1&belongstatus=1&id=" + ids;
...
//-------------------------------
   ...
   var ids = findSelections("checkbox_template","id");  //取得多选框的选择项
        ...
        var url="<%=request.getContextPath()%>/AgentEmpSendPostAction.do?cmd=detailPerOrder&belongStatus=1&id=" +ids;
...
<div id="ccChild0" class="search"> 
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
            ...
            <td width="70" align="center">离职时间</td>
     <td align="left">
            <w:date  id="apply_off_post_date1" name="apply_off_post_date1" format="yyyy-MM-dd"  width="180px"/>  </td>
        </tr>
		<tr>
            ...
            <td >
                <d:select dictTypeId="EMP_STATUS"  value="2" id="emp_status" name="emp_status"></d:select>
            </td>
...
<div style="padding: 8 10 8 8;">
    <r:datacell id="datacell1" queryAction="/FAERP/AgentEmpSendPostAction.do?cmd=simpleApplyOffQuery"  width="98%" height="320px" xpath="AgentEmpSendPostVo" paramFormId="datacell_formid" readonly="true">
        ...
        <r:field fieldName="apply_off_post_date" label="离职日期">
         <w:date allowInput="true" id="apply_off_post_date" name="apply_off_post_date" format="YYYY-MM-DD" property="bean/apply_off_post_date" width="190px" readonly="true"/>
        </r:field>
        <r:field fieldName="post_status_bd" label="入离职状态">
            <d:select dictTypeId="POST_STATUS_BD" />
        </r:field>
         <r:field fieldName="charge_end_date" label="收费截至">
         <w:date allowInput="true" id="charge_end_date" name="charge_end_date" format="YYYY-MM-DD" property="bean/apply_off_post_date" width="190px" readonly="true"/>
        </r:field>
