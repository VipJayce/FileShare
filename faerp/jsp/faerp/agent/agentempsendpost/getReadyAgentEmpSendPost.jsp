...
<script language="javascript">
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
        ...
        var url="<%=request.getContextPath()%>/AgentEmpSendPostAction.do?cmd=find&belongstatus=0&id=" + ids;
...
<div id="right">
<script language="javascript">
	writeTableTopFesco('待派派工单','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
...
<div id="ccParent1" class="button"> 
    <div class="button_right">
        <ul>
            ...
            <li class="b"><a onClick="javascript:findCheckbox_onClick();">派出</a></li>
        </ul>
    </div>
    <div class="clear"></div>			
</div>
...
<div style="padding: 8 10 8 8;">
    <r:datacell id="datacell1" queryAction="/FAERP/AgentEmpSendPostAction.do?cmd=simpleNewQuery"  width="98%" height="320px" xpath="AgentEmpSendPostVo" paramFormId="datacell_formid" readonly="true">
