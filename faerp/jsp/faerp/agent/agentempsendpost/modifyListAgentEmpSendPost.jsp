...
<script language="javascript">
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
		...
		var url="<%=request.getContextPath()%>/AgentEmpSendPostAction.do?cmd=find&belongstatus=2&id=" + ids;
...
<div id="right">
<script language="javascript">
	writeTableTopFesco('变更派工单维护','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
...
<div style="padding: 8 10 8 8;">
    <r:datacell id="datacell1" queryAction="/FAERP/AgentEmpSendPostAction.do?cmd=simpleQueryModifySendPost"  width="98%" height="320px" xpath="AgentEmpSendPostVo" paramFormId="datacell_formid" readonly="true">
