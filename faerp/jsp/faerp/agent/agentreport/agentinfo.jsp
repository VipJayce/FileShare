...
<script language="javascript">
    function exportEXCEL_onClick(){
      ...
      if( !checkForm(frm) ) {
        ...
        var agent_id = $id("agent_List").getValue();
        ...
        url = "<%=request.getContextPath()%>/jsp/faerp/agent/agentreport/showinfo.jsp?raq=agent_info.raq&city_id="+city_id+"&agent_id="+agent_id;
...
<div id="right">
<script language="javascript">
       writeTableTopFesco('供应商信息表','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
    ...
    <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
              ...
              <td align="left" class="td_2">
                     <r:comboSelect id="agent_List" name="agent_id"
                       queryAction="/FAERP/SalagentAction.do?cmd=getAgentListByCity"
                       valueField="id"
