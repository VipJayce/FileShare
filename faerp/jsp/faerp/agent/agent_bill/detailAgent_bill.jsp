...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getInvoice_status())%></td>
		</tr>
		<tr>
			<td class="td_1" >rate_amount：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getRate_amount())%></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getVoucher_status())%></td>
		</tr>
		<tr>
			<td class="td_1" >voucher_ym：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getVoucher_ym())%></td>
		</tr>
		<tr>
