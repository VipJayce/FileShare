...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
	...
	<r:datacell id="datacell1"
            queryAction="/FAERP/AgentAction.do?cmd=queryAllGetByCust&cust_id=${param.cust_id}" 
            isCount="false"
            width="100%" 
            xpath="AgentVo" 
            readonly="true"
            ...
            <r:field allowModify="false" fieldName="id_index" sortAt="none" label="<input type='hidden' name='checkall' value='' onclick='' />" width="50px" onRefreshFunc="setCheckbox" >
               ...
               -->
            <r:field fieldName="agent_code" width="100px" label="供应商编号" >
            </r:field>
              <r:field fieldName="agent_name" width="250px" label="供应商名称" >
            </r:field>
            <r:field fieldName="agent_type" width="100px" label="供应商类型">
            <d:select  dictTypeId="AGENT_TYPE" id="agent_type" name="agent_type" />
            </r:field>
           <r:field fieldName="city_name" width="150px" label="城市"  >
            </r:field>
