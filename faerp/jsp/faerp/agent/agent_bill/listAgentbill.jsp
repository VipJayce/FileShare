...
function generateThreadBill(){
    var frm = $id("datacell_formid");
   //  frm.submitAction="/FAERP/BillCreateAction.do?cmd=generateBillThread";
     //alert('generateThreadBill');
      //表单验证
      if( !checkForm(frm) ) {
   ...
   //设置button不能点击
   $id("button_ok").disabled="disabled" ;
    var ajax = new Ajax('/FAERP/Agent_billAction.do?cmd=generateBillThread');
    ajax.addParam("ids", ids);
     //添加参数agent_id
    ajax.addParam("agent_id",agent_id);
    ajax.submitForm(frm);
...
<body>
        ...
        <div id="bg" class="xixi1" >
            <div id="font1" class="tab1" onMouseDown="setTab03Syn(1);document.getElementById('bg').className='xixi1'">生成账单</div>
...
<table width="100%" border="0">
	...
	<tr>
		...
		<div align="center" >
        <input name="button_ok2" class="icon_1"      type="button" value='查询薪资' onClick="javascript:searchSalary()">
		<input name="button_ok" id="button_ok"  class="icon_1"		type="button" value='生成账单' onClick="javascript:generateBill()">
		<input name="button_ok" id="button_ok"  class="icon_3"		type="button" value='后台生成账单' onClick="javascript:generateThreadBill()">
		
		<input name="button_reset" class="icon_1"   type="button" value='精度设置' onClick="javascript:openNewWin();"></div>
		</td>
		<td align="right"></td>
	</tr>
...
<r:datacell id="datacell1"  
    queryAction="/FAERP/Agent_billAction.do?cmd=searchSalary"
	 width="98%" height="304px" 
	 xpath="SalarybatchVo" 
	 submitAction="/FAERP/Agent_billAction.do?cmd=generateBill"
	...
	<r:field fieldName="pay_name" label="薪资发放名称" width="250px" allowModify="false">
	</r:field>
	<r:field fieldName="pay_year_month" label="薪资所属月" allowModify="false" width="150px">
		<h:text />
	</r:field>
	<r:field fieldName="tax_month" label="薪资计税年月" width="190px" allowModify="false">
		<h:text />
	</r:field>
	<r:field fieldName="bill_year_month" label="薪资账单年月" width="205px" allowModify="false">
		<h:text />
	</r:field>
...
<div id="tab2inner" style="padding: 8 10 8 8;" ><!--  queryLog1为查询全国供应商部分的日志-->
