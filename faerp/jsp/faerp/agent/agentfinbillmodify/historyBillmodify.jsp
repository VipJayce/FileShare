...
<head>
	...
	<title>账单明细查看</title>
	<script language="javascript" src="<venus:base/>/jsp/faerp/agent/agentfinbillmodify/historybillmodify.js"></script>
    ...
    <script language="javascript">
        function exportEXCEL_onClick(){
	        ...
	        if(bill_id != null && bill_id !=""){
	            $id("datacell_formid").action="<%=request.getContextPath()%>/jsp/faerp/reportJsp/showBillModifyReport.jsp?raq=agent_bill.raq&arg1="+bill_id+"&arg2="+cost_center_name+"&arg3="+bill_year_month+"&arg4="+bill_code+"&arg5="+login_name;
