...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <div style="padding: 8 10 8 8;">
    <r:datacell  id="datacell1"      
        queryAction="/FAERP/AgentServiceProductAction.do?cmd=queryProductData"
        width="98%" height="300px" xpath="AgentServiceProductVo" 
    ...
    <r:field fieldName="id" label="操作" width="35px" onRefreshFunc="setCheckboxStatus"  align="center" ></r:field>
        ...
        <r:field fieldName="city_id" label="城市" width="100px" allowModify="true">
          <r:comboSelect id="cityList" name="cityList " queryAction="/FAERP/PB_CITYAction.do?cmd=getListData" textField="city_name" valueField="id" nullText=""  xpath="PB_CITYVo" ></r:comboSelect>               
        </r:field>
