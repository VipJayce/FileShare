...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
           <td class="td_1" >客户名称</td>
            <td class="td_2 ">
                <input type="text" class="text_field" id="cust_name" name="cust_name" inputName="cust_code" value="${bean.cust_name }" maxLength="25" readonly="readonly" size="28"/>
            </td>
      ...
      <td align="left" class="td_2"><input name="send_name" id="send_name" value="${bean.send_name }" readonly="readonly" size="28"> </td>
        ...
        <td class="td_2 ">
        <input name="cust_receive_customer" id="cust_receive_customer" value="${bean.cust_receive_name}" readonly="readonly" size="28">
          
            </td>
           <td class="td_1" >委托单位</td>
          <td class="td_2 ">
              <input name="cust_send_customer" id="cust_send_customer" value="${bean.cust_send_name}" readonly="readonly" size="28">
            </td>
