...
<%  //取出List
	...
	if(request.getAttribute(IAgent_fin_bill_itemConstants.REQUEST_BEANS) != null) {  //如果request中的beans不为空
		lResult = (List)request.getAttribute(IAgent_fin_bill_itemConstants.REQUEST_BEANS);  //赋值给resultList
	}
...
<script language="javascript">
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
		...
		form.action="<%=request.getContextPath()%>/Agent_fin_bill_itemAction.do?id=" + ids;
		form.cmd.value = "find";
		form.submit();
	}  
	function deleteMulti_onClick(){  //从多选框物理删除多条记录
		...
		if(confirm('<fmt:message key="sure_to_delete"/>')) {  //如果用户在确认对话框按"确定"
	    	form.action="<%=request.getContextPath()%>/Agent_fin_bill_itemAction.do?ids=" + ids;
	...
	function toAdd_onClick() {  //到增加记录页面
		form.action="<%=request.getContextPath()%>/jsp/faerp/agent/agent_fin_bill_item/insertAgent_fin_bill_item.jsp";
		form.submit();
	}
...
<form name="form" method="post" action="<%=request.getContextPath()%>/Agent_fin_bill_itemAction.do">
...
<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"company_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"bill_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"product_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"emp_post_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"bill_year_month")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"service_year_month")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"amount")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"serial_no")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_base")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_base")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_ratio")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_ratio")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_add_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_add_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"security_product_item_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"security_product_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_verification")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"claim_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"verification_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_valid")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_del")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_user_id")%>">
			...
			<th>
				 	...
				 	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_date")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"employee_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_sum")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"bill_source_bd")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"bill_source_bd")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"bill_source_bd")%>">
           	</a>	
       
			 bill_source_bd</th>
			<th>
				
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"old_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/Agent_fin_bill_itemAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"previou_oldid")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"previou_oldid")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"previou_oldid")%>">
           	</a>	
...
<td><bean:write name="data" property="company_id"/>   </td>
			...
			<td><bean:write name="data" property="bill_source_bd"/>   </td>
			
			<td><bean:write name="data" property="old_id"/>   </td>
			
			<td><bean:write name="data" property="previou_oldid"/>   </td>
...
<script language="javascript">
<%  //表单回写
	if(request.getAttribute(IAgent_fin_bill_itemConstants.REQUEST_WRITE_BACK_FORM_VALUES) != null) {  //如果request中取出的表单回写bean不为空
		out.print(RmVoHelper.writeBackMapToForm((java.util.Map)request.getAttribute(IAgent_fin_bill_itemConstants.REQUEST_WRITE_BACK_FORM_VALUES)));  //输出表单回写方法的脚本
	}
%>
</script>	
