...
var delItems={};
 ...
 function update_onClick(){
       ...
       var myDate = new Date();
          ...
          var dataset1 = $id("datacell1").dataset;
              var len1 = dataset1.getLength();
                ...
                if(IsProduct()){
                var url="<%=request.getContextPath()%>/AgentprojectbookAction.do?cmd=updateproduct&id="+projectid;
     ...
     var param = jQuery("#datacell_formid").serialize();
        ...
        jQuery.post(url,function(data1){
...
<script language="javascript">
    if(<%=isModify%>)
        writeTableTopFesco('修改项目书','<%=request.getContextPath()%>/');
    else
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
 ...
 <div id="ccParent1" class="button" >
    ...
    <div class="button_right" style="padding-left: 10px">
       ...
       <input class="bc"  type="<%=isModify?"button":"hidden"%>" style="padding-left:1px"  value="<fmt:message key="save"/>"  onClick="toSaveProduct_onClick();">
    </div>
    <div class="clear"></div>
    </div>
    ...
    <r:datacell  id="datacell1"
        ...
        submitAction="/FAERP/AgentpbserviceproductAction.do?cmd=updatepbProduct"
       ...
       <r:field fieldName="service_product_id" label="操作" width="35px" onRefreshFunc="setCheckboxStatus1"  align="center" ></r:field>
        ...
        <r:field fieldName="product_price" label="价格" width="70px" allowModify="true" ><h:text validateAttr="allowNull=false;type=float" onchange="countAllMoney(); "/>
         ...
         <r:field fieldName="start_date" label="开始日期" width="85px" allowModify="true">
        <w:date format="yyyy-MM-dd"   />
        </r:field>
        <r:field fieldName="end_date" label="截止日期" width="85px" allowModify="true">
            <w:date format="yyyy-MM-dd" extAttr="validateAttr='allowNull=false'" />
         </r:field>
    ...
    <input class="c" type="button"   value="<fmt:message key="insert"/>"    onClick="toAddItem_onClick();">
       ...
       <input class="bc"  type="<%=isModify?"button":"hidden"%>" style="padding-left:1px"  value="<fmt:message key="save"/>"    onClick="toSaveItem_onClick();">
    </div>
    <div class="clear"></div>
    </div>
    <div style="padding: 8 10 8 8;">
...
<div class="mx_button" align="center">
         <input type="<%=isModify?"hidden":"button"%>" class="icon_2" value="上一页" onClick="javascript:dsep_onClick();" />
        <input type="button" class="icon_2" id="save1" value='<fmt:message key="save"/>' onClick="javascript:<%=isModify?"update_onClick()":"insert_onClick()"%>" />  
