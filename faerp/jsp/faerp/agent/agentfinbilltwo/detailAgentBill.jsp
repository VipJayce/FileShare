...
<body>
<form name="form" method="post" id="datacell_formid" action="AgentFinBillTwoAction.do?cmd=list2item4approval2">
<div id="right">
<script language="javascript">
...
<div class="ringht_s">
	...
	<div class="xz_title" style="margin-top:10px;">一次收费项目表</div>
  	 <r:datacell id="celllist1"
			queryAction="/FAERP/AgentFinBillTwoAction.do?cmd=queryBillOther&bill_id=${billVo.id}"
