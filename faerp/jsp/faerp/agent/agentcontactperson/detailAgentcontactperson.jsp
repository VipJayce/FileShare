...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getContact_name())%></td>
		</tr>
		<tr>
			<td class="td_1" >contact_tel：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getContact_tel())%></td>
		</tr>
		<tr>
			<td class="td_1" >contact_email：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getContact_email())%></td>
		</tr>
		<tr>
			<td class="td_1" >contact_post：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getContact_post())%></td>
		</tr>
		<tr>
			<td class="td_1" >备注：</td>
