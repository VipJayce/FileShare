...
<%@ page import="rayoo.agent.agentcontactperson.vo.AgentcontactpersonVo" %>
<%@ page import="rayoo.agent.agentcontactperson.util.IAgentcontactpersonConstants" %>
<%  //取出List
	List lResult = null;  //定义结果列表的List变量
	if(request.getAttribute(IAgentcontactpersonConstants.REQUEST_BEANS) != null) {  //如果request中的beans不为空
		lResult = (List)request.getAttribute(IAgentcontactpersonConstants.REQUEST_BEANS);  //赋值给resultList
	}
	Iterator itLResult = null;  //定义访问List变量的迭代器
	if(lResult != null) {  //如果List变量不为空
		itLResult = lResult.iterator();  //赋值迭代器
	}
	AgentcontactpersonVo resultVo = null;  //定义一个临时的vo变量
%>
<html>
...
<script language="javascript">
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
		...
		form.action="<%=request.getContextPath()%>/AgentcontactpersonAction.do?id=" + ids;
		form.cmd.value = "find";
		form.submit();
	}  
	function deleteMulti_onClick(){  //从多选框物理删除多条记录
		...
		if(confirm('<fmt:message key="sure_to_delete"/>')) {  //如果用户在确认对话框按"确定"
	    	form.action="<%=request.getContextPath()%>/AgentcontactpersonAction.do?ids=" + ids;
	...
	function toAdd_onClick() {  //到增加记录页面
		form.action="<%=request.getContextPath()%>/jsp/faerp/agent/agentcontactperson/insertAgentcontactperson.jsp";
		form.submit();
	}
...
<form name="form" method="post" action="<%=request.getContextPath()%>/AgentcontactpersonAction.do">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="contact_name" inputName="contact_name" maxLength="50"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			<td align="right">contact_tel</td>
			<td align="left">
				<input type="text" class="text_field" name="contact_tel" inputName="contact_tel" maxLength="6.5"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			<td align="right">contact_email</td>
			<td align="left">
				<input type="text" class="text_field" name="contact_email" inputName="contact_email" maxLength="250"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			<td align="right">contact_post</td>
			<td align="left">
				<input type="text" class="text_field" name="contact_post" inputName="contact_post" maxLength="50"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
...
<th>
			  	...
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"agent_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"contact_name")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"contact_name")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"contact_name")%>">
           	</a>	
       
			 contact_name</th>
			<th>
				
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"contact_tel")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"contact_tel")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"contact_tel")%>">
           	</a>	
       
			 contact_tel</th>
			<th>
				
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"contact_email")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"contact_email")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"contact_email")%>">
           	</a>	
       
			 contact_email</th>
			<th>
				
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"contact_post")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"contact_post")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"contact_post")%>">
           	</a>	
       
			 contact_post</th>
			<th>
				
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"remark")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_del")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"create_user_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"create_user_name")%>">
			...
			<th>
				 	...
				 	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"create_date")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_user_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_user_name")%>">
			...
			<th>
				 	...
				 	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_date")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentcontactpersonAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"company_id")%>">
...
<td><bean:write name="data" property="agent_id"/>   </td>
			...
			<td><bean:write name="data" property="contact_name"/>   </td>
			
			<td><bean:write name="data" property="contact_tel"/>   </td>
			
			<td><bean:write name="data" property="contact_email"/>   </td>
			
			<td><bean:write name="data" property="contact_post"/>   </td>
...
<script language="javascript">
<%  //表单回写
	if(request.getAttribute(IAgentcontactpersonConstants.REQUEST_WRITE_BACK_FORM_VALUES) != null) {  //如果request中取出的表单回写bean不为空
		out.print(RmVoHelper.writeBackMapToForm((java.util.Map)request.getAttribute(IAgentcontactpersonConstants.REQUEST_WRITE_BACK_FORM_VALUES)));  //输出表单回写方法的脚本
	}
%>
</script>	
