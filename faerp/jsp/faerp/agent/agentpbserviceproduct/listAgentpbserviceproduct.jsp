...
<%  //取出List
	...
	if(request.getAttribute(IAgentpbserviceproductConstants.REQUEST_BEANS) != null) {  //如果request中的beans不为空
		lResult = (List)request.getAttribute(IAgentpbserviceproductConstants.REQUEST_BEANS);  //赋值给resultList
	}
...
<script language="javascript">
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
		...
		form.action="<%=request.getContextPath()%>/AgentpbserviceproductAction.do?id=" + ids;
		form.cmd.value = "find";
		form.submit();
	}  
	function deleteMulti_onClick(){  //从多选框物理删除多条记录
		...
		if(confirm('<fmt:message key="sure_to_delete"/>')) {  //如果用户在确认对话框按"确定"
	    	form.action="<%=request.getContextPath()%>/AgentpbserviceproductAction.do?ids=" + ids;
	...
	function toAdd_onClick() {  //到增加记录页面
		form.action="<%=request.getContextPath()%>/jsp/faerp/agent/agentpbserviceproduct/insertAgentpbserviceproduct.jsp";
		form.submit();
	}
...
<form name="form" method="post" action="<%=request.getContextPath()%>/AgentpbserviceproductAction.do">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="right">service_product_id</td>
			<td align="left">
				<input type="text" class="text_field" name="service_product_id" inputName="service_product_id" maxLength="9.5"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="product_id" inputName="product_id" maxLength="5"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field_half" name="product_price_from" inputName="product_price" value="" columnSize="" decimalDigits="5" />&nbsp;到&nbsp;<input type="text" class="text_field_half" name="product_price_to" inputName="product_price" value="" columnSize="" decimalDigits="5" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			<td align="right">frequency_bd</td>
			<td align="left">
				<input type="text" class="text_field" name="frequency_bd" inputName="frequency_bd" maxLength="25"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
...
<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"projectbook_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"service_product_id")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"service_product_id")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"service_product_id")%>">
           	</a>	
       
			 service_product_id</th>
			<th>
				
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"product_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"product_price")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"frequency_bd")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_del")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"create_user_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"create_user_name")%>">
			...
			<th>
				 	...
				 	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"create_date")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_user_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_user_name")%>">
			...
			<th>
				 	...
				 	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_date")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/AgentpbserviceproductAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"company_id")%>">
...
<td><bean:write name="data" property="projectbook_id"/>   </td>
			...
			<td><bean:write name="data" property="service_product_id"/>   </td>
...
<script language="javascript">
<%  //表单回写
	if(request.getAttribute(IAgentpbserviceproductConstants.REQUEST_WRITE_BACK_FORM_VALUES) != null) {  //如果request中取出的表单回写bean不为空
		out.print(RmVoHelper.writeBackMapToForm((java.util.Map)request.getAttribute(IAgentpbserviceproductConstants.REQUEST_WRITE_BACK_FORM_VALUES)));  //输出表单回写方法的脚本
	}
%>
</script>	
