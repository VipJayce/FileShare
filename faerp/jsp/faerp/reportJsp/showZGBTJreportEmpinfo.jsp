...
<%
    ...
    if(report_type_bd.equals("1")){
        param.append("arg1=").append(start_date).append(";");
        param.append("arg2=").append(end_date).append(";");
        param.append("arg3=").append(start_date.substring(0,4)+"年"+start_date.substring(5,7)+"月"+start_date.substring(8)+"日--"+end_date.substring(0,4)+"年"+end_date.substring(5,7)+"月"+end_date.substring(8)+"日");
