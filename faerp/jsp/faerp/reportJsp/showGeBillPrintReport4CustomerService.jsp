...
<%
	...
	String cust_service=request.getParameter("arg9");
	String cust_group=request.getParameter("arg10");//客户组code
    ...
    param.append("arg8=").append(company_id).append(";");
    param.append("arg9=").append(cust_service).append(";");
    param.append("arg10=").append(cust_group).append(";");
%>
