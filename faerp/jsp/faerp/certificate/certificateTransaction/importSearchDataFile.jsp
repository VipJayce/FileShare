...
<script language="javascript">
    function import_onClick() {
        ...
        form.action="<%=request.getContextPath()%>/CertificateTransactionAction.do?cmd=importSearchDataFile";
        form.submit();  
    }
</script>
...
<table>
    ...
    <tr>
        <td align="right">有效日期格式用yyyy-MM-dd</td>
        <td align="left">，并且将单元格设为文本。</td>
    </tr>
