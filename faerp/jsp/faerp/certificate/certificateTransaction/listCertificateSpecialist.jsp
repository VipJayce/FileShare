...
Medicalkit = "Medicalkit";
    ...
    String personnelCategory = request.getAttribute("personnelCategory") == null ? "" : request.getAttribute("personnelCategory").toString();
%>
...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
    ...
    function simpleQuery_onClick(){  //简单的模糊查询
          $id("celllist1").addParam("name",$id("name").value);
    ...
    <input type="hidden" name="personnelCategory" id="personnelCategory" value="<%= personnelCategory %>">
    <div id="ccChild0" class="search">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="170" rowspan="3" style="padding-top: 0;">
          <div class="search_title">查询条件</div></td>
        </tr>
        <tr>
            <td align="left">人员名称</td>
            <td align="left">
                <input type="text" rowspan="2" class="text_field" name="name" id="name" inputName="员工姓名" maxLength="50"/>           
              </td>
        </tr>
        <tr>
            <td align="left">部门名称</td>
            <td align="left">
                <input type="text" rowspan="2" class="text_field" name="department" id="department" inputName="部门" maxLength="50"/>           
              </td>
    ...
    <div class="clear"></div>
         ...
         <div  id="div1" style="margin:5 0 0 10px;">
                            <r:datacell 
                            queryAction="/FAERP/CertificateTransactionAction.do?cmd=getCertificateSpecialist"
                            id="celllist1"
                            paramFormId="datacell_formid" 
                            width="97%" height="305px" 
                            xpath="CertificateSpecialistSimpleVO"
                            readonly="true"
                            >
                          <r:toolbar location="bottom" tools="nav,pagesize,info"/>
                          <r:field fieldName="name" label="人员名称" width="300px">
                          <h:text />
                          </r:field>
                          <r:field fieldName="department" label="部门名称" width="300px">
                          <h:text />
                          </r:field>
                        </r:datacell>
            </div>
