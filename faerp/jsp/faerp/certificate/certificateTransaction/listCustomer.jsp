...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
    ...
    function select_onClick(){
        ...
        returnAry[2] = entity.getProperty("customer_code");
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="166" align="left">公司编号</td>
    ...
    <div class="clear"></div>
         ...
         <div  id="div1" style="margin:5 0 0 10px;">
                            <r:datacell 
                            queryAction="/FAERP/CustomersimpleAction.do?cmd=getCustomerList1"
                            id="celllist1"
                          ...
                          <r:field fieldName="customer_code" label="公司编号" width="150px">
                            <h:text />
                          </r:field>
                          <r:field fieldName="customer_name" label="公司名称" width="300px">
                          <h:text />
                          </r:field>
                        </r:datacell>
            </div>
