      ...
      <table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
         <tr>
	          ...
	          <td class="td_2 " width="25%">
	            <%=gap.rm.tools.helper.RmJspHelper.getSelectField("type", -1, "MAIL_RECEIVE_TYPE", beanVo.getType(), "id='type' style='width:320px'", false) %> </td>
	          <td class="td_1"  width="25%"><fmt:message key='name'/></td>
	          <td class="td_2 " width="25%">
              <input type="text" class="text_field" name="name" maxLength="50" id="name" value="${bean.name}" />
	          </td> 
	          </tr>
	          <tr>
	          <td class="td_1"  width="25%"><fmt:message key='mail'/></td>
              <td class="td_2 " width="25%" colspan="3"> 
                <input type="text" class="text_field" name="mail" maxLength="50" id="mail" value="${bean.mail}"/>
             </tr>
      </table>
    </div>
    <div>
