...
<script language="javascript">
    function upload_onClick() {
        ...
        form.action = "attachUpload.jsp?uploadDir=<%=uploadDir%>&arg=<%=arg%>";
        try {
              form.submit();
        } catch(e) {
              alert(e.message);
...
%>
    ...
    function test(){
        ...
        var nameId="<%=arg.equals("1")?"identificaFileName":(arg.equals("2")?"appraiseFileName":(arg.equals("3")?"claimFileName":"null")) %>";
        var addressId="<%=arg.equals("1")?"identificaFileAddress":(arg.equals("2")?"appraiseFileAddress":(arg.equals("3")?"claimFileAddress":"null")) %>";
        window.parent.opener.document.getElementById(nameId).value=name;
        window.parent.opener.document.getElementById(addressId).value=address;
