...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
    ...
    <div class="clear"></div>
         ...
         <div  id="div1" style="margin:5 0 0 10px;">
                            <r:datacell 
                            queryAction="/FAERP/WorkTimeApplyAction.do?cmd=getEmpOrResigSpecialist"
                            id="celllist1"
                            paramFormId="datacell_formid" 
                            width="97%" height="305px" 
                            xpath="EmpOrResigSpecialistVO"
                            readonly="true"
                            >
                          <r:toolbar location="bottom" tools="nav,pagesize,info"/>
                          <r:field fieldName="name" label="用退工专员" width="300px">
                          <h:text />
                          </r:field>
                        </r:datacell>
            </div>
