...
//-------------------------------
   ...
   function import_onClick() {
	...
	<input type="hidden" name="cmd" value="queryAllOperateLog"> 
	...
	<div class="button_right">
	   <!-- 
		...
		<input class="g_1" type="button" id="save_validDate" onclick="save_validDate_onClick();" value="保存有效期"<au:authorityBtn code="modify_CredentTran" type="1"/>>
	 -->
	</div>
	<div class="clear"></div>
	</div>
	<div style="padding: 8 10 8 8;"><r:datacell id="datacell1"
		queryAction="/FAERP/CertificateTransactionAction.do?cmd=queryOperateLog"
		width="98%" height="303px" xpath="OperateLogVO"
		...
		<r:field fieldName="operateName"	messagekey="employeeName" width="60px"></r:field>
		<r:field fieldName="operateTime" messagekey="identity" width="55px"></r:field>
		<r:field fieldName="employeeId" messagekey="employeeCardNumber" width="130px"></r:field>
		<r:field fieldName="employeeName"  messagekey="companyNumber" width="80px"></r:field>
        <r:field fieldName="empCode"  messagekey="companyName" width="300px"></r:field>
        <r:field fieldName="customerCode"  messagekey="customerService" width="80px"></r:field>
        <r:field fieldName="customerName"  messagekey="customerService" width="80px"></r:field>
        <r:field fieldName="credentialsTypeBd"  messagekey="cardTranTypeBD" width="100px">
        ...
        <r:field fieldName="remark"  messagekey="tranState" width="120px"></r:field>
	</r:datacell></div>
	   <!--翻页 end--> 
