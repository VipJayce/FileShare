...
<script language="javascript">
    function exportEXCEL_onClick(){
      ...
      if( !checkForm(frm) ) {
        ...
        url = "<%=request.getContextPath()%>/jsp/faerp/reportJsp/showBillDifference.jsp?raq=BILL_DEFFERENCE_STA.raq&costcenter="+costcenter+"&bill_yearmonth="+bill_yearmonth+"&login_userid=<%=login_user_id%>";
