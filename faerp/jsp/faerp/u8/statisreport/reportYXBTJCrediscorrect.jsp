...
<script language="javascript">
    function exportEXCEL_onClick(){
        ...
        $id("datacell_formid").action="<%=request.getContextPath()%>/jsp/faerp/reportJsp/showZGBTJreportEmpinfo.jsp?raq=report_YXBTJ_crediscorrect.raq&start_date="+start_date+"&end_date="+end_date+"&report_type_bd=1";
