...
<script language="javascript">
    ...
    function cancel_onClick(){  //取消后返回列表页面
        ...
        function rtnFunc_product1(arg){
            var lookup = $id("product_id1");
            lookup.value = arg[0];
            lookup.displayValue = arg[1];
            return false;
        }
...
<div class="xz_title">凭证与二级科目对照设置</div>
<%if(isModify){ %>
	<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        <tr>
            ...
            <td class="td_1" ><span class="style_required_red">* </span>选择二级科目</td>
            <td class="td_2" >
            <w:lookup onReturnFunc="rtnFuncSubjcode2" readonly="true"  id="subjcode" name="subjcode"
            lookupUrl="/U8_subjectAction.do?cmd=getQueryPage&v1_ccode=${subjcode}"
        ...
        <td class="td_1" id="v5_td2_1">&nbsp;</td>
        <td class="td_2" id="v5_td2_2">&nbsp;</td> 
        <td class="td_1" id="v6_td2_1" style="display:none">选择产品</td>
            <td class="td_2" id="v6_td2_2" style="display:none">
                <w:lookup onReturnFunc="rtnFunc_product1" readonly="true"  id="product_id1" name="product_id1"
                lookupUrl="/ProductAction.do?cmd=queryAllProductVoucher"
                dialogTitle="选择产品" height="450" width="850" style="width:188px" value="${bean.product_id}" displayValue="${product_name}" />  
                </td>      
        </tr>
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        <tr>
            ...
            <td class="td_2" >
            <w:lookup onReturnFunc="rtnFuncSubjcode2" readonly="true"  id="subjcode" name="subjcode"
            lookupUrl="/U8_subjectAction.do?cmd=getQueryPage&v1_ccode=${param.subjcode}"
...
function ruletype_onClick(val,igrade) {
		          ...
		          if(strval=='1'){
		          	_$("#v5_td2_1").css("display","none");
		          	_$("#v5_td2_2").css("display","none");
		          	_$("#v6_td2_1").css("display","block");
		          	_$("#v6_td2_2").css("display","block");
		          }else{
		          	_$("#v5_td2_1").css("display","block");
		          	_$("#v5_td2_2").css("display","block");
		          	_$("#v6_td2_1").css("display","none");
		          	_$("#v6_td2_2").css("display","none");
		          }
