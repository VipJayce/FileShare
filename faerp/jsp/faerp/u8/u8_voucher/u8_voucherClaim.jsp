...
function createVoucher(){
	...
	showProgressBar();
	jQuery.post("<%=request.getContextPath()%>/U8_voucher_remarkAction.do?cmd=createVoucherClaim&"+_p,function(data){
           if(data){
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="" style="font-size:12px;">
	...
	<tr>
		...
		<td class="td_2" align="right"><bean:write name="incoming" property="inc_amout"/> </td>
		<td class="td_2" align="right"><bean:write name="incoming" property="inc_amout"/> </td>
	</tr>
</table>
...
if(voucher.isCreatFlag()&&claim_status.equals("0")){
%>                        
