...
function createVoucher(){
	...
	//alert(_p);
	showProgressBar();
	jQuery.post("<%=request.getContextPath()%>/U8_voucher_remarkAction.do?cmd=createVoucher&"+_p,function(data){
           if(data){
...
<input type="hidden" name="voucher_status" id="voucher_status" value='<bean:write name="bill" property="voucher_status"/>'/>
<input type="hidden" name="voucher_ym" id="voucher_ym" value='<bean:write name="bill" property="voucher_ym"/>'/>
<%
