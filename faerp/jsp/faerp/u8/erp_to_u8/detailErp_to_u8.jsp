...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		<tr>
			<td align="right" width="10%" nowrap>ERP用户ID：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getErp_partid())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>U8用户ID：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getU8_cuser_id())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>生效日期：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getStartdate(), 10)%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>失效日期：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getEnddate(), 10)%></td>
		</tr>
		<tr>
