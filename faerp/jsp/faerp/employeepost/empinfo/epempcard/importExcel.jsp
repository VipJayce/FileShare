...
<script language="javascript">
    function insert_onClick(){  //插入单条数据
         ...
         if(file1 == null || file1 == ""){
             alert("<fmt:message key="imp_file_not_null"/>");
             return;
         }
         if(file1!="xls"){
         ...
         if(checkAllForms()){
            form.action="<%=request.getContextPath()%>/EpempcardAction.do?cmd=importExcelForEmpcard";
...
<table>
    <tr>
         <td width="12%" align="right"><fmt:message key="file_imp"/>:</td>
          <td width="20%" align="left">
               <input type="file" id="fileInput" name="file1"  validate="notNull;"  inputName="导入文件"  >
          </td>
    </tr>
    <tr>
        <td align="right"><button onclick="javascript:insert_onClick()"><fmt:message key="import"/></button></td>
