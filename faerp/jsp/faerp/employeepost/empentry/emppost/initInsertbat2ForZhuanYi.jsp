...
//报价单
String quo_id = (String)session.getAttribute("quo_id");
//员工ID  
String emp_ids = (String)session.getAttribute("emp_ids");
//员工入离职ID ----------------------------------- 多个
String emppostIds = (String)session.getAttribute("emppostIds");
//客户
String customer_id = (String)session.getAttribute("customer_id");
//接受单位
String cust_receive_id = (String)session.getAttribute("cust_receive_id");
//委派单ID
...
<div id="right">
    <div class="tab">
        ...
        <table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
          ...
          <tr>
            ...
            <div id="values_div">
                    <r:datacell 
                         id="firsttbody"
                         queryAction="/FAERP/EmppostAction.do?cmd=initInsertBat2ForZhuanYi"
                         ...
                         <r:field fieldName="isonline" label="是否线上">
                             <d:select dictTypeId="TrueOrFalse" nullLabel="--请选择--"/>
                         </r:field>
        ...
        <div id="TabCon2" >
            ...
            <div class="foot_button">
                <input type="button" class="foot_icon_1" value="<fmt:message key="go_one"/>" onClick="location.href='<%=request.getContextPath()%>/jsp/faerp/employeepost/empentry/emppost/initInsertbat1ForZhuanYi.jsp'"/>
...
jQuery(document).ready(function() {
        ...
        Me.afterInit = function(){
	       ...
	       //福利产品列头的设定
           var getIndex2 = 25 + array5.length*5;
           //alert(getIndex2);
