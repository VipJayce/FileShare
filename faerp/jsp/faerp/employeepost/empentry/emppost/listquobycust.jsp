...
<fmt:bundle basename="rayoo.employeepost.empentry.emppost.emppost_resource" prefix="rayoo.employeepost.empentry.emppost.">
    ...
    <input type="hidden" name="cust_id" id="cust_id" value="${requestScope.cust_id}"/>
    ...
    <div class="clear"></div>
         ...
         <div  id="div1" style="margin:5 0 0 10px;">
                            <r:datacell 
                            queryAction="/FAERP/EmppostAction.do?cmd=getQuotationByCust&cust_id=${requestScope.cust_id}"
                            id="celllist1"
