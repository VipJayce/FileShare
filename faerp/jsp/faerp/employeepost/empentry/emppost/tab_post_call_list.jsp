 ...
 <script  language="javascript">
    var tabs;
     function updateData() { //定义修改状态时显示的标签页
        tabs  =  new Array(
            new Array ("<fmt:message key="on_post_query"/>","<%=request.getContextPath()%>/EmppostAction.do?cmd=queryEntryList"),
            new Array ("<fmt:message key="css_issue_query"/>","<%=request.getContextPath()%>/EmpIssueAction.do?cmd=queryEmpIssue")
        );
