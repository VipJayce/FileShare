            ...
            if (form) {
             ...
             if( returnNode ) {
                 if( myAjax.getValue("root/data/returnValue") == 1 ) {
                      window.location.href="<%=request.getContextPath()%>/jsp/faerp/employeepost/empentry/emppost/initInsertbat2.jsp?isLimitUpperAndLower=${isLimitUpperAndLower}";
...
<div>
    ...
    <input id="security_unit_id" name="security_unit_id" type="hidden" value="<%=RmStringHelper.prt(postsendVo.getSecurity_unit_id())%>"/>
