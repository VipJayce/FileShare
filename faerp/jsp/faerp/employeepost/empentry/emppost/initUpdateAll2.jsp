         ...
         <input type="button" class="a_2" value="<fmt:message key="look_person_order"/>" <au:authorityBtn code="view_orderItem4" type="1"/> onClick="detail_onClick();" />
            ...
            <div id="values_div">
                    <r:datacell
                         ...
                         submitAction="/FAERP/EmppostAction.do?cmd=updatePostAll"
                         width="100%"
                         xpath="EmppostVo"
...
jQuery(document).ready(function() {
        ...
        Me.afterInit = function(){
           ...
           //福利产品列头的设定
           var getIndex2 = 11 + array4.length*4;
           //alert(getIndex2);
	    ...
	    Me.afterEdit = function (newValue,oldValue){
            ...
            if(input_date==null || input_date=='') return true;
