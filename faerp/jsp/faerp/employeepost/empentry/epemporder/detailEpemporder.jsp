...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			<td class="td_1" >总额：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getOrder_amount())%></td>
		</tr>
		<tr>
			<td class="td_1" >调整任务导入批次号：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getAdjust_task_imp_batch_id())%></td>
		</tr>
		<tr>
			<td class="td_1" >调整任务号：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getAdjust_task_id())%></td>
		</tr>
		<tr>
