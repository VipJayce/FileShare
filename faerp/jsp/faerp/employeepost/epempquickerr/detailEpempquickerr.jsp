...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		...
		<tr>
			<td align="right" width="10%" nowrap>error_msg：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getError_msg())%></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right" width="10%" nowrap>city_name：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getCity_name())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>city_code：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getCity_code())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>contract_type：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getContract_type())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>quotation_id：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getQuotation_id())%></td>
		</tr>
		<tr>
...
<input type="hidden" name="id" value="<%=RmStringHelper.prt(resultVo.getContract())%>">
