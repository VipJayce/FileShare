...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getAct_name())%></td>
		</tr>
		<tr>
			<td class="td_1" >活动性质：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getAct_type())%></td>
		</tr>
		<tr>
			<td class="td_1" >活动时间：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getAct_date(), 10)%></td>
		</tr>
		<tr>
			<td class="td_1" >活动地点：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getAct_address())%></td>
		</tr>
		<tr>
			<td class="td_1" >主办人：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getHost_user_id())%></td>
		</tr>
		<tr>
			<td class="td_1" >联系方式：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getCountact_way())%></td>
		</tr>
		<tr>
			<td class="td_1" >备注：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getDesc())%></td>
		</tr>
		<tr>
