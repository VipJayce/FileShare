	   ...
	   //选择一条记录
		function select_onClick(){
		    ...
		    if(type==1){
                ...
                returnAry[3] = entity.getProperty("emp_id_card");
                returnAry[4] = entity.getProperty("emp_post_id");
                returnAry[5] = entity.getProperty("cust_code");
                returnAry[6] = entity.getProperty("cust_name");
                returnAry[7] = entity.getProperty("user_name");  //客服名称
                returnAry[8] = entity.getProperty("is_phoenix");  //是否入职E化
                returnAry[9] = entity.getProperty("apply_on_post_date");  //入职日期
                returnAry[10] = entity.getProperty("post_status_bd");  //入离职状态
		    }else if(type==2){
		        //返回材料信息
		        returnAry[0] = entity.getProperty("material_id");
                returnAry[1] = entity.getProperty("material_name");
		    }
...
<body>
   <form name="form" method="post"  id="datacell_formid">
    <div id="ccChild0" class="search">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        ...
	        <c:if test="${type ==1}">
	         ...
	         <c:if test="${type == 2}">
	            <tr>
	                <td width="166" align="left">材料名称</td>
	                <td width="328" align="left">
	                    <input type="text" class="text_field" name="material_name" id="material_name" inputName="材料名称"/>            
	                </td>
    ...
    <div  id="div1" style="margin:5 0 0 10px;">
        <c:if test="${type ==1}">
	          <r:datacell 
	          queryAction="/FAERP/EmpMaterialAction.do?cmd=searchEmpMaterialData&type=1"
	          id="celllist1"
        ...
        <c:if test="${type ==2}">
            <r:datacell 
              queryAction="/FAERP/EmpMaterialAction.do?cmd=searchEmpMaterialData&type=2&emp_id=${emp_id}"
              id="celllist1"
              paramFormId="datacell_formid" 
              ...
              >
                <r:toolbar location="bottom" tools="nav,pagesize,info"/>
                <r:field fieldName="material_id" label="材料id" width="0px">
                </r:field>
                <r:field fieldName="material_name" label="材料名称" width="100px">
                </r:field>
            </r:datacell>
        </c:if>
