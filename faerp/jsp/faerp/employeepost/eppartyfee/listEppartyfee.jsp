...
//tab切换
    ...
    function selectTabSyn ( i )
    {
        switch(i){
            ...
            $("#box_tab").empty();
            $("#box_tab").append(" <iframe id = \"paypartyfee\" name=\"paypartyfee\"  src=\"<%=request.getContextPath()%>\/jsp/faerp/employeepost/eppartyfee/payPartyfee.jsp\" scrolling=\"no\"  frameBorder=0 width=\"100%\" height=\"500px;\"><\/iframe>");
          //  document.all.paypartyfee.src="<%=request.getContextPath()%>/jsp/faerp/employeepost/eppartyfee/payPartyfee.jsp";
            ...
            $("#box_tab").empty();
            $("#box_tab").append(" <iframe id = \"paypartyfee\" name=\"paypartyfee\"  src=\"<%=request.getContextPath()%>\/jsp/faerp/employeepost/eppartyfee/notPayPartyfee.jsp\" scrolling=\"no\"  frameBorder=0 width=\"100%\" height=\"500px;\"><\/iframe>");
...
<div class="ringht_s">
    <div class="tab">
        <div id="bg" class="xixi1">
            <div id="font1" class="tab1" onMouseDown="setTabSyn(1);document.getElementById('bg').className='xixi1'"><fmt:message key="have_been_disbursed_query"/></div>
            <div id="font2" class="tab2" onMouseDown="setTabSyn(2);document.getElementById('bg').className='xixi2'"><fmt:message key="no_payment_query"/></div>
        </div>

                <div class="box_tab" id="box_tab">
              <iframe id = "paypartyfee" name="paypartyfee"  src="<%=request.getContextPath()%>/jsp/faerp/employeepost/eppartyfee/payPartyfee.jsp" scrolling="no"  frameBorder=0 width="100%" height="500px;"></iframe>
         </div>
