...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getInc_date())%></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getExc_message())%></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getExc_rownum())%></td>
		</tr>
		<tr>
			<td class="td_1" >上传人：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getUpload_user())%></td>
		</tr>
		<tr>
