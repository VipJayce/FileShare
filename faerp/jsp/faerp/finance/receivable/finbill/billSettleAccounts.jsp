...
<script type="text/javascript">
	...
	function locked(val){
		...
		var confirmStr = null;
		 if(val == 1){
		 	confirmStr = "<fmt:message key='alert_is_settle'/>";
		 }else if(val == 0){
		 	confirmStr = "<fmt:message key='alert_is_unsettle'/>";
		 }
		 if(confirm(confirmStr)){
	   	...
	   	if(flag){
	   	        var urlstr="/FAERP/FinbillAction.do?cmd=SettleAccountsBill&ids=" + ids+"&settleaccountsbill="+val;
	   	    ...
	   	    /*
	   		jQuery.getJSON("/FAERP/FinbillAction.do?cmd=SettleAccountsBill&ids=" + ids,{"settleaccountsbill":val},function(json){
...
<div id="right">
	<div class="right_title_bg">
	  <div class=" right_title"><fmt:message key='title_settle_accounts'/></div>
	</div>
    <div class="ringht_s">
    <!--查询 -->
  <div class="search">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <!--表格 -->
        ...
        <div style="padding: 5 0 0 8">
          <input type="button" name="lock" id="lock" <au:authorityBtn code="jcjz_jz" type="1"/>  value="<fmt:message key='button_settleAccounts'/>" class="icon_1" onclick="locked(1)" />
          <input type="button" name="unlock" id="unlock" <au:authorityBtn code="jcjz_jcjz" type="1"/>  value="<fmt:message key='button_unsettleAccounts'/>" class="icon_1" onclick="locked(0)" />
    </div>
    ...
    <div id="values_div3" style="width:100%;height:200px; padding: 5 0 8 8;">
       	<r:datacell id="celllist1"
			...
			paramFormId="datacell_formid" width="99%" height="305px"
			...
			<r:field fieldName="cust_name" messagekey="cust_name" width="230px">
				<h:text />
			</r:field>
			...
			<r:field fieldName="is_closed" messagekey="is_closed" width="135px">
				<h:select name="is_closed1" property="is_closed1">
                   <h:option value="0" label="未结账"></h:option>
                   <h:option value="1" label="结账"></h:option>
                </h:select>
			</r:field>
			<r:field fieldName="bill_amount" messagekey="bill_amount" width="110px">
				<h:text />
			</r:field>
