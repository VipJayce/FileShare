...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		...
		<tr>
			<td align="right" width="10%" nowrap>start_year_month：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getStart_year_month())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>end_year_month：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getEnd_year_month())%></td>
		</tr>
		<tr>
