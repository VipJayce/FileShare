...
function save_onClick (){
    ...
    var action="<%=request.getContextPath()%>/FinbillAction.do?cmd=insertBillAndBillothers";
    ...
    myAjax.addParam("customer_id",customer_id);
...
<input  type="hidden"  value="<%=cost_center_id %> " id="cost_center_id" />
<input  type="hidden"  value="<%=billyearmonth %> " id="billyearmonth"/>
<div id="right">
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <td class="td_2" ><input  style="width:190px" id="amount"  onkeyup="clearNoNum(this)" /> </td>
         <td class="td_1"> 备注</td>
