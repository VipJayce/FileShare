...
<%  //取出List
	...
	if(request.getAttribute(IBillitemhisConstants.REQUEST_BEANS) != null) {  //如果request中的beans不为空
		lResult = (List)request.getAttribute(IBillitemhisConstants.REQUEST_BEANS);  //赋值给resultList
	}
...
<script language="javascript">
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
		...
		form.action="<%=request.getContextPath()%>/BillitemhisAction.do?id=" + ids;
		form.cmd.value = "find";
		form.submit();
	}  
	function deleteMulti_onClick(){  //从多选框物理删除多条记录
		...
		if(confirm('<fmt:message key="sure_to_delete"/>')) {  //如果用户在确认对话框按"确定"
	    	form.action="<%=request.getContextPath()%>/BillitemhisAction.do?ids=" + ids;
	...
	function toAdd_onClick() {  //到增加记录页面
		form.action="<%=request.getContextPath()%>/jsp/faerp/finance/bill/billitemhis/insertBillitemhis.jsp";
		form.submit();
	}
...
<form name="form" method="post" action="<%=request.getContextPath()%>/BillitemhisAction.do">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="right">old_bill_item_id</td>
			<td align="left">
				<input type="text" class="text_field" name="old_bill_item_id" inputName="old_bill_item_id" maxLength="9.5"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
...
<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"company_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"old_bill_item_id")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"old_bill_item_id")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"old_bill_item_id")%>">
           	</a>	
       
			 old_bill_item_id</th>
			<th>
				
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"service_year_month")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"product_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"emp_post_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"amount")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"serial_no")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_base")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_base")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_ratio")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_ratio")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_add_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_add_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"security_product_item_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"security_product_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_sum")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_exclusive_security")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_exclusive_accumulation")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_exclusive_salary")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/BillitemhisAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_exclusive_tax")%>">
...
<td><bean:write name="data" property="company_id"/>   </td>
			...
			<td><bean:write name="data" property="old_bill_item_id"/>   </td>
...
<script language="javascript">
<%  //表单回写
	if(request.getAttribute(IBillitemhisConstants.REQUEST_WRITE_BACK_FORM_VALUES) != null) {  //如果request中取出的表单回写bean不为空
		out.print(RmVoHelper.writeBackMapToForm((java.util.Map)request.getAttribute(IBillitemhisConstants.REQUEST_WRITE_BACK_FORM_VALUES)));  //输出表单回写方法的脚本
	}
%>
</script>	
