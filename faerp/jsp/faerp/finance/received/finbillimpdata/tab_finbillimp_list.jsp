 ...
 <script  language="javascript">
    var tabs;
     function updateData() { //定义修改状态时显示的标签页
        tabs  =  new Array(
            new Array ("导入海拉尔账单","<%=request.getContextPath()%>/FinbillimpdataAction.do?cmd=toListPageBeijingLargeTable"),
            new Array ("导入历史","<%=request.getContextPath()%>/FinbillimpbatchAction.do?cmd=toListHistoryUpload&type=2")
        );
