 ...
 <script  language="javascript">
    var tabs;
     function updateData() { //定义修改状态时显示的标签页
        tabs  =  new Array(
            new Array ("导入全国系统账单","<%=request.getContextPath()%>/FinbillimpdatacountryAction.do?cmd=toListNationalSystemBill"),
            new Array ("导入历史","<%=request.getContextPath()%>/FinbillimpbatchnAction.do?cmd=toListHistoryUpload"),
            new Array ("获取全国账单","<%=request.getContextPath()%>/FinbillimpdatacountryAction.do?cmd=toGetExpressBillPage")
        );
