...
function rtnFunc(arg){
 ...
 function UploadFileWindow(){
    ...
    function upload_onClick(){  //上传
        ...
        var cust_code=$id("lk_clz").getValue();
        ...
        //导入数据类型  实收
        var bill_imp_type_db ='2' ;

        var attach_address = document.form1.attach_address.value;
        var bill_year_month = document.form1.bill_year_month.value;
        
        var url="<%=request.getContextPath()%>/FinbillimpdatacountryAction.do?cmd=importBillForNationalSystemGE&attach_address="+attach_address+"&bill_year_month="+bill_year_month +"&batch_name="+batch_name+"&bill_imp_type_db="+bill_imp_type_db+"&cust_code="+cust_code ;
        url=encodeURI(url); 
         showProgressBar();
    ...
    function downLoad_onClick(){
        $id("datacell_formid").action="<%=request.getContextPath()%>/FinbillimpdatacountryAction.do?cmd=downLoadExcel&type=GE";
        $id("datacell_formid").submit();
    }
         ...
         <td class="td_1"><span style="color:red">*</span><fmt:message key='batch_name'/></td>
           <td class="td_2">
             <input type="text" class="text_field" name="batch_name"
				id="batch_name" inputName="导入批次名称" style="width:210px"/></td>
           </td>
		   <td class="td_1"><span style="color:red">*</span>选择客户</td>
		   <td class="td_2">
			<w:lookup name="customer_name" onReturnFunc="rtnFunc" id="lk_clz" 
                lookupUrl="/CustomersimpleAction.do?cmd=getAllCustomerByCondition" messagekey="select_customer" height="450" width="610" style="width:190px"/>
		   </td>

           <td class="td_2" colspan="2">
           <!--  
           <input  type="radio"  id="bill_imp_type_db1" name="bill_imp_type_db" value="1"  disabled="disabled"/>预收&nbsp;&nbsp;&nbsp;
           <input  type="radio"  id="bill_imp_type_db2" name="bill_imp_type_db" checked="checked"  value="2" disabled="disabled"/>实收
           -->
           </td>
        </tr>
        <tr>
           ...
           <td class="td_2">
               ...
               <input type="button" class="icon_2"  value="下载模板"   <au:authorityBtn code="qgxtzd_xzqgxtzd" type="1"/>  onClick="downLoad_onClick();">
           </td>
          </tr>
        </table>
        </form>
 ...
 <form name="form2" method="post" id="datacell_formid">
    ...
    <div id="displaydiv" style="display:none">
       ...
       <div class="social_tab">
          ...
          <div id="font1" class="social_tab1" onMouseDown="setTab03Syn(1);document.getElementById('bg').className='social_xixi1'">导入GE账单</div>
   ...
   <r:field fieldName="a87" messagekey="a87">
           ...
           <r:datacell 
               ...
               <r:field fieldName="failure_reason" messagekey="failure_reason" width="400px">
                   <h:text/>
               </r:field>
               <r:field fieldName="cust_name" messagekey="cust_name">
                   <h:text/>
