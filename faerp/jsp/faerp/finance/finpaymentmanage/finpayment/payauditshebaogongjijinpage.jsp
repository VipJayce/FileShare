...
function rtnFuncUser(arg){
    ...
    function appOperate_onClick(){
      ...
      if(message==null)return;
        ...
        document.getElementById("cmd").value="shebaogongjijin_appoperate";
        form.submit();
    ...
    function backOperate_onClick(){
        ...
        if(message==null)return;
        form.action="<venus:base/>/FinpaymentAction.do?message="+message[0];
        document.getElementById("cmd").value="shebaogongjijin_backoperate";
        form.submit();
    }
	...
	<table width="100%" height="35" border="0" cellpadding="0"
		...
		<tr>
			...
			<td class="td_1">受款客户</td>
			<td class="td_2">
			<div>
			<w:lookup onReturnFunc="rtnFuncCustomer" readonly="false" id="cust_id" name="cust_id" lookupUrl="/CustomersimpleAction.do?cmd=getAllCustomerByCondition" dialogTitle="选择客户" height="440" width="600"  style="width:170px"/>
			</div>
			</td>
		</tr>
		<tr>
		<!-- 
			<td class="td_1">受款员工</td>
			<td class="td_2">
			<w:lookup onReturnFunc="rtnFuncUser" readonly="false" id="emp_id" name="emp_id" lookupUrl="/FinpaymentAction.do?cmd=getAllEmployeeByCondition" dialogTitle="选择员工" height="440" width="600" style="width:170px"/>
			 -->
		...
		<tr>
			...
			<td class="td_2"><input name="invoice_num" inputName="单据数量" type="text" class="sText" id="invoice_num" value="${bean.invoice_num}" validate="notNull;isNum;" maxLength="8" onkeyup="if(isNaN(value))execCommand('undo')"/></td>
			...
			<td class="td_2"><input name="apply_amount" inputName="申请支付金额"
				...
				<td class="td_1">系统金额</td><!-- 实际支付金额 -->
             <td class="td_2"><input name="audit_amount"  type="text" class="sText"  id="AUDIT_AMOUNT" value="${bean.audit_amount}" readonly="readonly" /></td>
		</tr>
		<tr>
			<td class="td_1">申请日期</td>
			<td class="td_2"><w:date name="apply_date" format="yyyy-MM-dd" width="170px" property="bean/apply_date"/>
			</td>
			<td class="td_1">应到款日：</td>
        	<td class="td_2"><w:date allowInput="false" id="should_pay_date" property="bean/should_pay_date" name="should_pay_date" format="yyyy-MM-dd"/></td>
        	<td class="td_1">垫付后预计到款日</td>
        	<td class="td_2"><w:date allowInput="false" id="expected_advanced_date" property="bean/expected_advanced_date" name="expected_advanced_date" format="yyyy-MM-dd"/></td>
		</tr>
		       
        <tr>
            <td class="td_1">垫付状态</td>
            <td class="td_2 "><d:select dictTypeId="REIMBURSE_STATUS_BD" property="reimburse_status_bd"  value="${bean.reimburse_status_bd}" id="reimburse_status_bd" style="width:190px" nullLabel="--请选择--" disabled="true" /></td>
            ...
            <% if(resultVo.getAttachment_id()!=null ){%>
            <td class="td_1" >附件</td>
            <td  class="td_2 " >
             <% out.print("<a href='"+request.getContextPath()+"/ProductAction.do?cmd=downLoad&attachment_id="+resultVo.getAttachment_id()+"'><font color=blue>"+resultVo.getAttachment_file_name()+"</font></a>"); %>
            </td>
           <%  }else{%>
           <td class="td_1"></td>
           <td class="td_2"></td>
        ...
        <tr>
            ...
            <td colspan="5" class="td_2"><textarea name="payment_purpose" style="width:99%;color: black;"
                inputName="付款用途" rows="3" class="xText_d" id="payment_purpose">${bean.payment_purpose}</textarea></td>
        </tr>
		<tr>
			<td class="td_1">付款原因</td>
			<td colspan="5" class="td_2"><textarea name="payment_reason" style="width:99%;color: black;"
				inputName="付款原因" rows="3" class="xText_d" id="payment_reason">${bean.payment_reason}</textarea></td>
		</tr>
		<tr>
			<td class="td_1">备注</td>
			<td colspan="5" class="td_2"><textarea name="payment_desc" style="width:99%;color: black;"
		      ...
		      <div id="values_div3" style="width:100%;height:200px; margin-top:5px;">
		                        <r:datacell 
                            id="celllist1"
                            queryAction="/FAERP/FinpaymentitemAction.do?cmd=searchPaymentItemData&payment_id=${bean.id}"
                          ...
                          <r:field fieldName="p_money" label="员工金额" width="100px">
                            <h:text />
                          </r:field>
                          <r:field fieldName="e_money" label="客户金额" width="100px">
                            <h:text />
                          </r:field>
             ...
             <div style="margin:5 0 0 0;">
                            <r:datacell 
                            queryAction="/FAERP/SalcontractAction.do?cmd=getSalcontractSPInto&contract_id=${bean.id}&wfname=SheBaoGongJiJinPayWorkFlow&wfname1=SheBaoGongJiJinPayWorkFlow"
                            id="datacell1"
                            paramFormId="datacell_formid" 
