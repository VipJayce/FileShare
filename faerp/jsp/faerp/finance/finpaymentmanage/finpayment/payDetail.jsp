...
<form name="form" id="datacell_formid" method="post">
	...
	<div id="TabCon1">
		      <div id="values_div3" style="width:100%;height:330px; margin:5 0 0 8;">
		                        <r:datacell 
                            id="celllist1"
                            queryAction="/FAERP/FinpaymentitemAction.do?cmd=searchPaymentItemData&payment_id=${param.id}"
                          ...
                          <r:field fieldName="service_year_month" messagekey="service_year_month" width="90px" allowModify="false">
                            <h:text />
                          </r:field>
                          <r:field fieldName="p_money" messagekey="p_money" width="90px" allowModify="false">
                            <h:text />
                          </r:field>
                          <r:field fieldName="e_money" messagekey="e_money" width="90px" allowModify="false">
                            <h:text />
                          </r:field>
