...
function rtnFuncUser(arg){
	...
	<table width="100%" height="35" border="0" cellpadding="0"
		...
		<tr>
			...
			<%
	              //payment_type_bd=10  体检支付
	              if(resultVo.getPayment_type_bd()!=null&&!resultVo.getPayment_type_bd().equals("10")){
            %> 
		...
		<tr>
          ...
          <td class="td_2">
            <input name="total_amount" inputName="已收款总金额"
                type="text" class="sText" id="total_amount" value="${bean.total_amount}" readonly="readonly"/>
           </td>
           <td class="td_1">&nbsp;</td>
            <td class="td_2">&nbsp;</td>
            <td class="td_1">&nbsp;</td>
...
_$(document).ready(function() {
    ...
    var reimburse_amount = 0;
    if(payment_type_bd == "12" || payment_type_bd == "13"){
       reimburse_amount = parseFloat(apply_amount)-parseFloat(total_amount);
       $id("reimburse_amount").value=reimburse_amount;
    }
