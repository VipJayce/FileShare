...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getPayment_amount())%></td>
		</tr>
		<tr>
			<td class="td_1" >received_amount：</td>
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getReceived_amount())%></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getPaytype())%></td>
		</tr>
		<tr>
