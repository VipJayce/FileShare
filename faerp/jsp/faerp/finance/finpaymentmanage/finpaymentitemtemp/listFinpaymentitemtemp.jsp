...
<%@ page import="rayoo.finance.payment.finpaymentitemtemp.vo.FinpaymentitemtempVo" %>
<%@ page import="rayoo.finance.payment.finpaymentitemtemp.util.IFinpaymentitemtempConstants" %>
<%  //取出List
	List lResult = null;  //定义结果列表的List变量
	if(request.getAttribute(IFinpaymentitemtempConstants.REQUEST_BEANS) != null) {  //如果request中的beans不为空
		lResult = (List)request.getAttribute(IFinpaymentitemtempConstants.REQUEST_BEANS);  //赋值给resultList
	}
	Iterator itLResult = null;  //定义访问List变量的迭代器
	if(lResult != null) {  //如果List变量不为空
		itLResult = lResult.iterator();  //赋值迭代器
	}
	FinpaymentitemtempVo resultVo = null;  //定义一个临时的vo变量
%>
<html>
...
<script language="javascript">
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
		...
		form.action="<%=request.getContextPath()%>/FinpaymentitemtempAction.do?id=" + ids;
		form.cmd.value = "find";
		form.submit();
	}  
	function deleteMulti_onClick(){  //从多选框物理删除多条记录
		...
		if(confirm('<fmt:message key="sure_to_delete"/>')) {  //如果用户在确认对话框按"确定"
	    	form.action="<%=request.getContextPath()%>/FinpaymentitemtempAction.do?ids=" + ids;
	...
	function toAdd_onClick() {  //到增加记录页面
		form.action="<%=request.getContextPath()%>/jsp/faerp/finance/finpaymentmanage/finpaymentitemtemp/insertFinpaymentitemtemp.jsp";
		form.submit();
	}
...
<form name="form" method="post" action="<%=request.getContextPath()%>/FinpaymentitemtempAction.do">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="cost_center_name" inputName="cost_center_name" maxLength="64"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field_half" name="e_money_from" inputName="e_money" value="" columnSize="" decimalDigits="5" />&nbsp;到&nbsp;<input type="text" class="text_field_half" name="e_money_to" inputName="e_money" value="" columnSize="" decimalDigits="5" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field_half" name="p_money_from" inputName="p_money" value="" columnSize="" decimalDigits="5" />&nbsp;到&nbsp;<input type="text" class="text_field_half" name="p_money_to" inputName="p_money" value="" columnSize="" decimalDigits="5" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
		...
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="paytype" inputName="paytype" maxLength="1"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
			<td align="right"></td>
...
<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"company_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"payment_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"cust_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"cust_code")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"cust_name")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"cost_center_name")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"cost_center_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"emp_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"emp_post_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"product_id")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"payment_month")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"payment_amount")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"received_amount")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"reimburse_amount")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_valid")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"is_del")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_user_id")%>">
			...
			<th>
				 	...
				 	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"last_update_date")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"e_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"p_money")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"start_month")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"end_month")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"fund_month")%>">
			...
			<th>
			  	...
			  	<a href="/FAERP/FinpaymentitemtempAction.do?cmd=queryAll&VENUS_ORDER_KEY=<%=royoo.common.TagSortUitl.getSortColumn(request,"paytype")%>">
            	<img src="/FAERP/images/<%=royoo.common.TagSortUitl.getSortImage(request,"paytype")%>" border="0" title="<%=royoo.common.TagSortUitl.getSortTitle(request,"paytype")%>">
           	</a>	
...
<td><bean:write name="data" property="company_id"/>   </td>
			...
			<td><bean:write name="data" property="paytype"/>   </td>
...
<script language="javascript">
<%  //表单回写
	if(request.getAttribute(IFinpaymentitemtempConstants.REQUEST_WRITE_BACK_FORM_VALUES) != null) {  //如果request中取出的表单回写bean不为空
		out.print(RmVoHelper.writeBackMapToForm((java.util.Map)request.getAttribute(IFinpaymentitemtempConstants.REQUEST_WRITE_BACK_FORM_VALUES)));  //输出表单回写方法的脚本
	}
%>
</script>	
