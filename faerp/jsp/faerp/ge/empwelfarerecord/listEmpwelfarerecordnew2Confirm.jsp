 ...
 function update_onClick(handle_type){
  ...
  jQuery.ajax({
    ...
    function  exportExcel_onClick(){
        ...
        $id("datacell_formid").action="<%=request.getContextPath()%>/EmpwelfarerecordAction.do?cmd=toConfirmPage";
    }
...
<body>
<form name="form" id="datacell_formid" action="EmpwelfarerecordAction.do?cmd=toConfirmPage" method="post"> 
...
<div id="right">
  ...
  <td align="right" style="width:80px">客户名称&nbsp;&nbsp;</td>
    ...
    <td  align="left" ><d:select  dictTypeId="DOCUMENT_STATUS" id="document_status" name="document_status" style="width:100px"   filterOp="in"  filterStr="1" value="${requestScope.document_status}"></d:select></td>    
