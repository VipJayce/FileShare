...
<script language="javascript">
    function insert_onClick(){  //插入单条数据
         document.getElementById("button4upload").disabled="disabled";
	     ...
	     if(checkAllForms()){
	        form.action="<%=request.getContextPath()%>/GeimphwtAction.do?cmd=importExcelForHwt";
	        form.submit();
	     }
    }
</script>
...
<table>
    ...
    <tr>
        <td align="right"><button onclick="javascript:insert_onClick()" id="button4upload"><fmt:message key="downlord"/></button></td>
