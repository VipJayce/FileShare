...
<script language="javascript">
    ...
    function updateStatus_onClick(){
    	...
    	var order_status = "5";                              //目标状态
    	var action = "<%=request.getContextPath()%>/Job_orderAction.do?cmd=updateOrderStatus";
        var xmlSubmit = datacell1.dataset.toString();
        var myAjax = new Ajax(action);
        myAjax.addParam("ids", ids);
        myAjax.addParam("order_status",order_status);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td align="left">
                 <d:select dictTypeId="RECURITTYPE" id="recruittype" name="recruittype" nullLabel="--请选择--"></d:select>
            </td>
...
<div id="ccParent1" class="button"> 
 <div class="button_right">
		<ul>
		    ...
		    <li class="p_1"><a onClick="javascript:updateStatus_onClick();">订单完成</a></li>                     
        </ul>
</div>
           <div class="clear"></div>			
</div>
...
<div style="padding: 8 10 8 8;">
 <r:datacell id="datacell1" queryAction="/FAERP/Job_orderAction.do?cmd=simpleQuery" width="98%" height="318px" xpath="Job_orderVo" paramFormId="datacell_formid">
 ...
 <r:field fieldName="contract_name" label="关联合同" allowModify="false" width="150px"></r:field>
 <r:field fieldName="customer_name" label="客户" allowModify="false" width="200px"></r:field>
 <r:field fieldName="warranty" label="担保期" allowModify="false" width="70px"></r:field>
  <r:field fieldName="recruittype" label="订单类型" allowModify="false" width="100px">
   <d:select dictTypeId="RECURITTYPE"></d:select>
  </r:field>
 <r:field fieldName="order_status" label="订单状态" allowModify="false" width="80px">
    <d:select dictTypeId="ORDER_STATUS_BD"></d:select>
 </r:field>
 <r:field fieldName="create_user_name" label="录入人" width="80px"></r:field>
