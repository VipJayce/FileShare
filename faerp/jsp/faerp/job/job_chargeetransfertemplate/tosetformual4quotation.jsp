    ...
    <td width="50%">
     ...
     <div class="zbox" style="float:left;">
        ...
        <% if(fromTpl){ %>
	        ...
	        <input type="hidden" id="chargebigitem_id" name="chargebigitem_id" value="${param.sc_id }">
	        </form>
	          <r:datacell id="datacell_sc_item" 
	              width="98%"
	            queryAction="/FAERP/Job_chargemiditemAction.do?cmd=queryForDatacell" height="160px"
		  ...
		  <%} else {%>
	            ...
	            <input type="hidden" id="chargebigitem_id" name="chargebigitem_id" value="${param.sc_id }">
	              ...
	              <r:datacell id="datacell_sc_item" 
		            queryAction="/FAERP/Job_chargemiditemAction.do?cmd=queryForDatacell" width="100%" height="160px"
		            submitAction="/FAERP/Job_chargemiditemAction.do?cmd=saveList"
		            xpath="Job_chargemiditemVo" paramFormId="sc_item_form"
		            submitXpath="Job_chargemiditemVo"
		                >
	              <r:toolbar location="bottom" tools="nav,pagesize,info"/>
	              <r:field fieldName="itemname" messagekey="name" width="100px" ></r:field>    
  ...
  <tr>
    <td>
	  ...
	  <% if(fromTpl){ %>
            ...
            <input type="hidden" id="chargetransfertemplate_id" name="chargetransfertemplate_id" value="${param.tpl_id }">
            
            </form>
	        
	        
	          <r:datacell id="datacell_para" 
            queryAction="/FAERP/Job_chargeparamAction.do?cmd=queryForDatacell" width="98%" height="100px"
          ...
          <%} else {%>
	            ...
	            <input type="hidden" id="chargetransfertemplate_id" name="chargetransfertemplate_id" value="${param.tpl_id }">
	              ...
	              <r:datacell id="datacell_para" 
		            queryAction="/FAERP/Job_chargeparamAction.do?cmd=queryForDatacell" width="98%" height="100px"
		            submitAction="/FAERP/Job_chargeparamAction.do?cmd=saveList"
		            xpath="Job_chargeparamVo" paramFormId="sc_form"
		            submitXpath="Job_chargeparamVo"
		            >
	          <r:toolbar location="bottom" tools="nav,pagesize,info"/>
	          <r:field fieldName="paramname" messagekey="name" width="100px" ></r:field>    
