        ...
        ajaxRequest(form,
                function(data){
                    if(true != data.error){ 
                        ...
                        jQuery("#bigchargetransfertemplate_id").val(data.template_id); 
                         jQuery("#smallchargetransfertemplate_id").val(data.template_id);
...
function update_onClick(){  //保存修改后的单条数据
      var dept_id=$id("outdept_id").getValue();
        ...
        if(confirm('确定要修改数据？')) {  //如果用户在确认对话框中点"取消"
...
<input type="hidden" name="id" id="charge_id" value="${bean.id }">
    <table  width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        <tr>
            ...
            <td class="td_2" >
                <input type="text" class="text_field" name="template_name" inputName="order_code" value="${bean.template_name }" maxLength="100" readonly="readonly" />
                <input type="hidden" name="chargetransfertemplate_id" id="chargetransfertemplate_id" value="${bean.chargetransfertemplate_id }" />
            </td>
        </tr>
        <tr>
        <td class="td_1" >费用划出部门</td>
            <td class="td_2" >
             <r:comboSelect id="outdept_id" name="outdept_id"
               ...
               <td class="td_1" rowspan="2" colspan="2" >
              
             <input  type="button" class="icon_2"  id="save1" value='保存' onClick="javascript:<%=isModify?"update_onClick()":"insert_onClick()"%>" />   
         ...
         <tr>
          <td class="td_1" >备注</td>  
          <td class="td_2" >
            <textarea rows="4" cols="70" name="description" id="transferset_description">${bean.description }</textarea>
            </td>
      ...
      if(orderchargetransferset_id==null||orderchargetransferset_id==""){
          ...
          return;
           ...
           var orderchargetransferset_deptid=document.getElementById("orderchargetransferset_deptid").value;
             var bigchargetransfertemplate_id=document.getElementById("bigchargetransfertemplate_id").value;
          ...
          entity.setProperty("chargetransfertemplate_id",bigchargetransfertemplate_id);
       ...
       <div id="table_show"  style="display:<%=isModify?"block":"none" %> " >
        <form action="" id="orderchargebigitemform" method="post">
            ...
            <input type="hidden" id="orderchargetransferset_deptid" name="orderchargetransferset_deptid" value="${bean.outdept_id }">
             <input type="hidden" id="bigchargetransfertemplate_id" name="chargetransfertemplate_id" value="${bean.chargetransfertemplate_id}">
            
         </form>
         <form action="" id="orderchargemiditemform" method="post">
          <input type="hidden" name="chargetransfertemplate_id" id="smalltransfertemplate_id" value="${bean.chargetransfertemplate_id }" />
