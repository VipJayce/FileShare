...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
            ...
            <td class="td_2 " width="28%">
                <input type="text" class="text_field" name="cust_code" id="cust_code" value="${bean.cust_code}" maxlength="25"  disabled="disabled"/>
       		</td>
       		<td class="td_1"  width="23%" ><span class="style_required_red">* </span>客户性质</td>
            <td class="td_2 " width="28%">
            	<d:select dictTypeId="CUSTOMER_PROPERTY" id="cust_quality" name="cust_quality" value="${bean.cust_quality}"/>
       		</td>
        </tr>
		<tr>
            <td width="23%" class="td_1" ><span class="style_required_red">* </span>客户名称</td>
            <td width="26%" class="td_2 " colspan="3">
                <input type="text" class="text_field"  name="cust_name" id="cust_name" inputName="客户名称" value="${bean.cust_name}" maxLength="50" validate="notNull;" readonly="true" />
            </td>
        </tr>
        <tr>
            <td class="td_1" >客户简称</td>
            <td class="td_2 ">
                <input type="text" class="text_field" id="cust_sname" name="cust_sname" inputName="客户简称" value="${bean.cust_sname}" maxLength="50" />
            </td>
            <td class="td_1" >客户英文名称</td>
            <td class="td_2 ">
                <input type="text" class="text_field" id="cust_ename" name="cust_ename" inputName="客户英文名" value="${bean.cust_ename}" maxLength="50" />
            </td>
        </tr>
        <tr>
            ...
            <td class="td_2" >
            	<d:select dictTypeId="CUSTOMER_TYPE" id="cust_type" name="cust_type" value="${bean.cust_type}"/>
            </td>
        </tr>
          <tr>
