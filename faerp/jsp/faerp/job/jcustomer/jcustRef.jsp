...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
    ...
    function select_onClick(){
        ...
        returnAry[1] = entity.getProperty("cust_code");
        returnAry[2] = entity.getProperty("cust_name");
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="166" align="left">客户编码</td>
            <td width="328" align="left">
          		<input type="text" class="text_field" name="cust_code" id="cust_code" maxLength="25"/> 
            </td>
        </tr>
        <tr>
            <td width="166" align="left">客户名称</td>
            <td width="328" align="left">
          		<input type="text" class="text_field" name="cust_name" id="cust_name" maxLength="25"/> 
            </td>
    ...
    <div class="clear"></div>
         ...
         <div  id="div1" style="margin:5 0 0 10px;">
                            <r:datacell 
                            queryAction="/FAERP/JcustomerAction.do?cmd=getJcustList"
                            id="celllist1"
                          ...
                          <r:toolbar location="bottom" tools="nav,pagesize,info"/>
                            <h:text />
                          <r:field fieldName="cust_code" label="客户编码" width="300px">
                          <h:text />
                          </r:field>
