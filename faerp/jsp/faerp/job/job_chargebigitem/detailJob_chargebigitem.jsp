...
<%@ page import="rayoo.job.job_chargebigitem.vo.Job_chargebigitemVo" %>
<%@ page import="rayoo.job.job_chargebigitem.util.IJob_chargebigitemConstants" %>
<%  //取出本条记录
	Job_chargebigitemVo resultVo = null;  //定义一个临时的vo变量
	resultVo = (Job_chargebigitemVo)request.getAttribute(IJob_chargebigitemConstants.REQUEST_BEAN);  //从request中取出vo, 赋值给resultVo
...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		<tr>
			<td align="right" width="10%" nowrap>项目名称：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getItemname())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>项目代码：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getItemcode())%></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right" width="10%" nowrap>是否计算：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getIscalculation())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>是否显示：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getIsshow())%></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right" width="10%" nowrap>费用转入部门：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getIndept_id())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>项目序号：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getItemnumber())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>费用项目类型：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getItemtype())%></td>
		</tr>
		<tr>
