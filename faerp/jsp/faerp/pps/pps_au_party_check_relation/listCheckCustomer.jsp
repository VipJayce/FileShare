...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
    ...
    function select_onClick(){
        ...
        returnAry[4] = entity.getProperty("pps_cust_mapping_id");
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <input type="text" class="text_field" name="customer_code" id="customer_code" inputName="客户编号" maxLength="25"/>            </td>
         ...
         <tr>
            ...
            <td align="left">
                <input type="text" class="text_field" name="customer_name" id="customer_name" inputName="客户姓名" maxLength="50"/>            </td>
    ...
    <div class="clear"></div>
         ...
         <div  id="div1" style="margin:5 0 0 10px;">
                            <r:datacell 
                            queryAction="/FAERP/Pps_au_party_check_relationAction.do?cmd=getCustomerList"
                            id="celllist1"
                          ...
                          <r:field fieldName="customer_code" label="客户编号" width="250px">
                            <h:text />
                          </r:field>
