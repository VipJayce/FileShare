...
<div id="ccChild0" class="box_3"> 
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		<tr>
			...
			<td class="td_2"><%=gap.rm.project.RmGlobalReference.get(IPps_erp_salary_relationConstants.DICTIONARY_, resultVo.getPps_bas_id())%></td>
		</tr>
		<tr>
			<td class="td_1">ERP薪资类别ID：</td>
			<td class="td_2"><%=gap.rm.project.RmGlobalReference.get(IPps_erp_salary_relationConstants.DICTIONARY_, resultVo.getErp_salary_id())%></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td_2" ><%=RmStringHelper.prt(resultVo.getO_remark())%></td>
		</tr>
		<tr>
