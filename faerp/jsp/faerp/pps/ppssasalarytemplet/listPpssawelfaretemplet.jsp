  ...
  function findSelections(checkboxName, idName) {  //从列表中找出选中的id值列表
   ...
   function toAdd_onClick(){
     var ids = findSelections("checkbox_template","id");  //取得多选框的选择项
        ...
        form.action="<%=request.getContextPath()%>/PpssasalarytempletAction.do?cmd=add_ppswelfaretemplet&type=welfaretemplet&id="+ids+"&_ts="+(new Date()).getTime();
        form.submit();
   }
   ...
   //跳转到查看页面
     ...
     var ids = findSelections("checkbox_template","id");  //取得多选框的选择项
        ...
        form.action="<%=request.getContextPath()%>/PpssasalarytempletAction.do?cmd=detail_ppswelfaretemplet&type=welfaretemplet&id="+ids+"&_ts="+(new Date()).getTime();
        form.submit();
   }
...
<body>
  ...
  <div id="right"><script language="javascript">
    writeTableTopFesco('福利项目管理','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
    <div class="ringht_s">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
           ...
           <w:lookup onReturnFunc="rtnFunc" lookupWidth="189px" readonly="true"  id="lk_cust" lookupUrl="/PpssasalarytempletAction.do?cmd=getAllCustomerByCondition" dialogTitle="选择客户" height="440" width="710"/>
            ...
            <td align="left">模版配置状态</td>
            <td align="left">
            <d:select dictTypeId="CHECK_STATUS" name="check_status" id="check_status" nullLabel="--请选择--" value=""/>
            </td>
        </tr>
        <tr>
    ...
    <input class="c" type="button" value="配置" onClick="toAdd_onClick();">
    </div>
    <div class="clear"></div>
    </div>

    <div style="padding: 8 10 8 8;"><r:datacell id="datacell1"
        queryAction="/FAERP/PpssasalarytempletAction.do?cmd=queryPpsTemplet"
        width="98%" height="318px" xpath="PpssasalarytempletVo"
        ...
        <r:field fieldName="salary_templet_code" label="模版代码" width="110px"></r:field>
        <r:field fieldName="salary_templet_name" label="模版名称"  allowModify="false" width="110px"></r:field>
        <r:field fieldName="check_status" label="模版配置状态" allowModify="false"  width="110px">
         <d:select dictTypeId="CHECK_STATUS"></d:select>
            </r:field>
    </r:datacell></div>
