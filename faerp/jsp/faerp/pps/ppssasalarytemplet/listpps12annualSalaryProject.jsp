...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <div style="padding: 8 10 8 8;">
    <r:datacell  id="datacell1"      
        queryAction="/FAERP/PpssasalarytempletAction.do?cmd=queryForSalaryProjectData&datatype=welfaresalary&templetid=${param.templet_id}"
    ...
    <r:field fieldName="id" label="操作" width="35px" onRefreshFunc="setCheckboxStatus"  align="center" ></r:field>
        <r:field fieldName="sa_item_name" label="薪资项目名称" width="150px">
          ...
          <r:field fieldName="annualsalary_property" label="12万年薪增减属性" width="70px">
