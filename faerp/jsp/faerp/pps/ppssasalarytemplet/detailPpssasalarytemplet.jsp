...
<table  width="100%" height="70" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <td class="td_2">
         <r:comboSelect id="sa_salaryitem_id" name="sa_salaryitem_id" queryAction="/FAERP/PpssasalarytempletAction.do?cmd=queryPpsSalaryItemData&salarytempletid=${bean.id}"
              textField="sa_item_name" valueField="id" xpath="PpssasalarytempletitemVo" width="200px" nullText="请选择" messagekey="please_choose" value="${itemid}" disabled="true"/> 
              </td>
                <td class="td_1">12万年薪是否显示&nbsp;</td>
              <td class="td_2">  <d:select dictTypeId="ANNUALSALARYDATA"  name="annualsalary12wdisplaydata" id="annualsalary12wdisplaydata" property="bean/annualsalary12wdisplaydata" disabled="true" /></td>
   ...
   <div class="clear"></div>
    ...
    <r:datacell  id="datacell1"
        ...
        <r:toolbar location="bottom" tools="nav,pagesize,info" />
         <r:field fieldName="sa_item_name" label="薪资项目名称" width="230px" allowModify="false" >
        </r:field>
        <r:field fieldName="sa_item_ename" label="薪资项目英文名称" width="230px" allowModify="false" >
        </r:field>
              <r:field fieldName="is_tax" label="是否扣税" width="200px" allowModify="false" >
        <d:select dictTypeId="TrueOrFalse" disabled="true"/>
        </r:field>
        <r:field fieldName="property" label="增减属性" width="200px" allowModify="false" >
   ...
   <div class="clear"></div>
    ...
    <r:datacell  id="datacell3"
        ...
        <r:toolbar location="bottom" tools="nav,pagesize,info" />
         ...
         <r:field fieldName="sa_item_ename" label="薪资项目英文名称" width="300px" allowModify="false" >
        </r:field>
        ...
        <d:select dictTypeId="PROPERTY" disabled="true" />
         ...
         <r:field fieldName="is_12annualsalary_property" label="12万年薪数据属性" width="245px" allowModify="true" >
          <d:select dictTypeId="annualsalary12wdata" disabled="true" />
         </r:field>
    </r:datacell>
     <!-- 12W年薪  end-->
