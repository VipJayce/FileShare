        ...
        if(ids!=null&&ids[0]!="")
        {
              ...
              if(json.beans!=null&&json.beans!="")
              {
                ...
                for(var i = 0 ;i<json.beans.length;i++)
                {
                       ...
                       newEntity.setProperty("welfare_display_order", json.beans[i].welfare_display_order);     
       ...
       for(var i = 0;i<ids.length;i++)
        { 
            ...
            for(var j=0;j<chid1.length;j++){
                var entity1=$id("datacell1").dataset.getAlltEntities();
                for( i=0;i<entity1.length;i++){
                 var ax=entity1[i];
                }
  ...
  function deleteMultiProduct_onClick(){
       ...
       if(confirm('确定要删除所选的产品吗？')) {  //如果用户在确认对话框按"确定"
        ...
        var elementCheckbox = document.getElementsByName("checkbox_template");
           ...
           datasettr.setProperty("welfare_display_order","");
   ...
   <div class="clear"></div>
    ...
    <r:datacell  id="datacell1"
        ...
        <r:toolbar location="bottom" tools="nav,pagesize,info" />
           ...
           <r:field fieldName="sa_item_ename" label="薪资项目英文名称" width="180px" allowModify="false" >
        </r:field>
            <r:field fieldName="payroll_name" label="工资单名称" width="255px" allowModify="false" >
        </r:field>
        <!--  
        ...
        -->
        <r:field fieldName="is_personal" label="是否个人福利" width="270"  sortAt="none">
           <d:select dictTypeId="PersonalORCompany" disabled="true"/>
        </r:field>
           <r:field fieldName="ishide" label="零值是否显示" width="270" >
           <d:select dictTypeId="TrueOrFalse" disabled="true" />
        </r:field>
          
        <r:field fieldName="welfare_display_order" label="排序" width="0"  allowModify="false" sortAt="true">
        </r:field>
    </r:datacell>
