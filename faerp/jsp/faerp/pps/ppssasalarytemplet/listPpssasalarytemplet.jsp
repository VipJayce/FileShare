  ...
  function findSelections(checkboxName, idName) {  //从列表中找出选中的id值列表
   ...
   function toAdd_onClick(){
     var ids = findSelections("checkbox_template","id");  //取得多选框的选择项
        ...
        form.action="<%=request.getContextPath()%>/PpssasalarytempletAction.do?cmd=add_ppssalarytemplet&type=salarytemplet&id="+ids+"&_ts="+(new Date()).getTime();
        form.submit();
   }
   ...
   //跳转到查看页面
     ...
     var ids = findSelections("checkbox_template","id");  //取得多选框的选择项
        ...
        form.action="<%=request.getContextPath()%>/PpssasalarytempletAction.do?cmd=detail_ppssalarytemplet&type=salarytemplet&id="+ids+"&_ts="+(new Date()).getTime();
        form.submit();
   }
...
<body>
  ...
  <div id="right"><script language="javascript">
    writeTableTopFesco('薪资项目管理','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
    <div class="ringht_s">
