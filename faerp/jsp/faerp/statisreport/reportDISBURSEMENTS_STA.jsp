...
<script language="javascript">
    function exportEXCEL_onClick(){
        ...
        var url1 ="<%=request.getContextPath()%>/jsp/faerp/reportJsp/showDISBURSEMENTS_STA.jsp?raq=DISBURSEMENTS_STA.raq&start_month="+start_month+"&end_month="+end_month;
...
<div id="right">
<script language="javascript">
       writeTableTopFesco('垫付款统计报表','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
