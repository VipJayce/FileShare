...
<script language="javascript">
    function exportEXCEL_onClick(){
        ...
        url = "<%=request.getContextPath()%>/jsp/faerp/reportJsp/showBusiAndDevDeptProfit.jsp?raq=BD_INCOME_STA.raq&start_yearmonth="+start_date+"&end_yearmonth="+end_date+"&login_userid=<%=login_user_id%>";
...
<div id="right">
<script language="javascript">
       writeTableTopFesco('业务拓展部利润表','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
