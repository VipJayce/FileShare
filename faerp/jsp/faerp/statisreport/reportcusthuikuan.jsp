...
<script language="javascript">
    function exportEXCEL_onClick(){
	    ...
	    if(flag=="1"){
	       var end_date = _$("#end_date").val();
	       //欠款金额
	       var debt_amount = _$("#debt_amount").val();
            ...
            if(parseInt(start_date.substring(0,4))<2013 || parseInt(end_date.substring(0,4))<2013){
                alert("统计年份不能小于2013年");
                return ;
            }
            if(debt_amount==null || debt_amount==""){
               debt_amount = 0;
            }
	         url="<%=request.getContextPath()%>/jsp/faerp/reportJsp/showhuikuan.jsp?raq=CUSTPAYMENT_STA.raq&start_date="+start_date+"&end_date="+end_date+"&debt_amount="+debt_amount+"&report_type_bd=1&flag=1";
	    }
        ...
        <tr>
            ...
            <table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
                <tr>
                    ...
                    <%}else{ %>
                     <td class="td_1" style="width:100px;">统计起始年月</td>
                     <td class="td_2" style="width:100px;">
                     ...
                     <td class="td_1" style="width:100px;">统计截止年月</td>
                     <td class="td_2" style="width:100px;">
                     ...
                     <%if ("1".equals(request.getParameter("flag"))){%>
	                     <td class="td_1" style="width:100px;">欠款金额</td>
	                     <td class="td_2" style="width:100px;">
	                        <input type="text" class="text_field" id="debt_amount" name="debt_amount" inputName="欠款金额"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
	                     </td>
                     <%} %>
                    <%} %>
                </tr>
...
<script>
    ...
    if(flag==1){
        ...
        var year = currentDate.getYear().toString();
        var month = (currentDate.getMonth()+1).toString();
        if(month<10){
            month = "0"+month;
        }
        
        _$("#end_date").val(year.toString()+month.toString());
    }
</script>
</html>
