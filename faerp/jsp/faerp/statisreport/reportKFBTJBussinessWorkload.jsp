...
<script language="javascript">
    function exportEXCEL_onClick(){
        ...
        if(type_bd=='1'){
            ...
            $id("datacell_formid").action="<%=request.getContextPath()%>/jsp/faerp/reportJsp/showZGBTJreportEmpinfo.jsp?raq=report_KFB_declareClass.raq&start_date="+start_date+"&end_date="+end_date+"&report_type_bd=1";
            $id("datacell_formid").submit();
        }
    }
</script>
