...
<script language="javascript">
    function exportEXCEL_onClick(){
       ...
       /** if(start_date==null || start_date==""){
        ...
        //$id("datacell_formid").action="<%=request.getContextPath()%>/jsp/faerp/reportJsp/showUserServiceEmpCount.jsp?raq=report_KFB_empservicecount.raq&start_date="+start_date+"&end_date="+end_date;
        //$id("datacell_formid").submit();
        
        url = "<%=request.getContextPath()%>/jsp/faerp/reportJsp/showUserServiceEmpCount.jsp?raq=report_KFB_empservicecount.raq&start_date="+start_date+"&end_date="+end_date;
...
<div id="right">
<script language="javascript">
       writeTableTopFesco('客服服务员工人数统计','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
