...
function insertMedical(){
    ...
    _param = jQuery("#formMedical").serialize();
    jQuery.post("<%=request.getContextPath()%>/NONNativeMedicalAction.do?cmd=update&"+_param,function(data){
           if(data > 0){
...
<h:hidden id="oid" name="id" property="bean/id"/>
  ...
  <div>
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
          <tr>
            ...
            <td class="td_2">
            <w:lookup onReturnFunc="rtnFuncEmployee" readonly="true" id="emp_name" name= "emp_name"  displayProperty="bean/emp_name" 
            ...
            <td class="td_2"><h:text id="id_card" name="id_card" property="bean/id_card" readonly="true"/></td>
            <h:hidden id="emp_id" name="emp_id" property="bean/emp_id"/>
            <h:hidden id="emp_code" name="emp_code" property="bean/emp_code"/>
          </tr>
          <tr>
          <td class="td_1"><span style="color:red;">*</span><fmt:message key='city'/></td>
            <td class="td_2"><h:text id="city" name="city" property="bean/city"/></td>
            <td class="td_1"><span style="color:red;">*</span><fmt:message key='tel'/></td>
            <td class="td_2"><h:text id="tel" name="tel" property="bean/tel"/></td>
           
          </tr>
          <tr>
            <td class="td_1"><span style="color:red;">*</span><fmt:message key='zip_code'/></td>
            <td class="td_2"><h:text id="zip_code" name="zip_code" property="bean/zip_code"/></td>
            <td class="td_1"><span style="color:red;">*</span><fmt:message key='address'/></td>
            <td class="td_2"><h:text id="address" name="address" property="bean/address"/></td>
          </tr>
          <tr>
            <td class="td_1"><span style="color:red;">*</span><fmt:message key='is_big_hz_area'/></td>
            <td class="td_2">
            <h:radio property="bean/is_big_hz_area" name="is_big_hz_area" value="1"/><fmt:message key='is_1'/>
            <h:radio property="bean/is_big_hz_area" name="is_big_hz_area" value="0"/><fmt:message key='is_0'/>
            </td>
            <td class="td_1"><span style="color:red;">*</span><fmt:message key='is_in_province'/></td>
            <td class="td_2">
            <h:radio property="bean/is_in_province" name="is_in_province" value="330002"/><fmt:message key='in'/>
            <h:radio property="bean/is_in_province" name="is_in_province" value="330001"/><fmt:message key='out'/>
            </td>
          </tr>
        </table>
  </div>
