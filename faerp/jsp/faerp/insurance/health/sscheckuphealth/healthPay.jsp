		       ...
		       <table width="100%" height="40" border="0" cellpadding="0"
                cellspacing="1" bgcolor="#c5dbe2">                
	                ...
	                <tr>
	                   ...
	                   <td class="td_2">
	                    <input inputName="受款方" type="text" class="sText" name="receiver_name" id="receiver_name"  validate="notNull;" maxLength="8" />
                      
	                   <!-- <input name="text3" type="text" class="sText" id="text3" value="建设银行"/> --></td>
	                   <td class="td_1"><span>*</span>单据数量</td>
	                   <td class="td_2">
	                     <input inputName="单据数量" type="text" class="sText" name="invoice_num" id="invoice_num" value="${count}" style="color:red;" validate="notNull;isNum;" maxLength="8" />
                      
	                  <!--  <input name="text9" type="text" class="sText" id="text9" value="${count}"   onblur="test9();"/> --></td>
	                </tr>
	                <tr>
	                   <td class="td_1">付款金额</td>
	                   <td class="td_2"><input type="text" style="background-color:#f0f0f0;" class="sText" id="audit_amount" name="audit_amount" value="${total_amount}" readonly="readonly"  /></td>
	                   <td class="td_1"><span>*</span>申请支付金额</td>
                       <td class="td_2"><input  type="text" class="sText" id="apply_amount" name="apply_amount"  value="${total_amount}" validate="notNull;isNum;" /></td>
                   </tr>
	                <tr>
