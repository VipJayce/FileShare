...
<div id="ccChild0" class="box_3"> 
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
            <td class="td_1" >工行笔数</td>
            <td class="td_2" ><%=RmStringHelper.prt(totalandamount1.getTotal_number())%></td>
            <td class="td_1" >工行总金额</td>
            <td class="td_2" ><%=RmStringHelper.prt(totalandamount1.getTotal_amount()) %></td>
