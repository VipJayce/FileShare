            ...
            <div class="box_tab">
                <table width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
                  ...
                  <tr>
                     ...
                     <td class="td_2" >
                        <input type="text" class="text_field" id="check_date" name="check_date" inputName="体检日期" value="" />                       
                     </td>
                  </tr>              
                  <tr>
                    <td class="td_1" ></td>
             ...
             <div>
                <r:datacell 
                  ...
                  <r:field fieldName="emp_name" label="客户编号" width="100px">
                                   
                   </r:field>    
                  <r:field fieldName="cust_name" width="140px" label="客户名称">
            
                  </r:field>
                  <r:field fieldName="is_secretary" width="240px" label="员工唯一号" >
            
                  </r:field>
                  <r:field fieldName="party_name" width="210px" label="员工名称">
                    
                  </r:field>
                  <r:field fieldName="start_date" label="员工身份证号码">
                   <w:date format="yyyy-MM-dd" id="start_date1" name="start_date1"/> 
                  </r:field>
                  <r:field fieldName="end_date" label="所属客服">
                    <w:date format="yyyy-MM-dd" id="end_date1" name="end_date1"/> 
                  </r:field>
                  <r:field fieldName="in_money" label="体检日期">
                   <h:text />
                  </r:field>
                  <r:field fieldName="don_money" label="结算金额" > 
                  </r:field>
                   <r:field fieldName="don_money" label="客户" > 
                  </r:field>
                   <r:field fieldName="don_money" label="部门" > 
                  </r:field>
                   <r:field fieldName="don_money" label="套餐类别" > 
                  </r:field>
                   <r:field fieldName="don_money" label="体检地点" > 
                  </r:field>
                   <r:field fieldName="don_money" label="体检供应商" > 
                  </r:field>
