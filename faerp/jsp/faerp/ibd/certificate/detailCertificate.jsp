...
<div id="ccChild0"> 
	<table class="viewlistCss" style="width:100%">
		<tr>
			<td align="right" width="10%" nowrap>员工id：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getEmp_id())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>status：</td>
			<td align="left"><%=RmStringHelper.prt(resultVo.getStatus())%></td>
		</tr>
		<tr>
			<td align="right" width="10%" nowrap>删除标识：</td>
		...
		<tr>
			<td align="right" width="10%" nowrap>创建人姓名：</td>
