...
/************************************服务项相关*****************************************/
    function toAddProduct_onClick(){      
      var url="<%=request.getContextPath()%>/jsp/faerp/ibd/ibdsalcontract/listibdproduct.jsp";
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
            ...
            <td class="td_2 " nowrap="nowrap">
               <w:lookup onReturnFunc="rtnFunc" lookupWidth="189px" readonly="true"         disabled="${create_type_bd==1?'true':'false'}"           displayValue="<%=customer_name %>" id="lk_cust" lookupUrl="/Finout_contract_productAction.do?cmd=getAllCustomerByCondition" dialogTitle="选择合同甲方" height="440" width="710" />
            ...
            <td class="td_2 " nowrap="nowrap">                
                <w:lookup onReturnFunc="rtnFunc1" lookupWidth="189px"      disabled="${create_type_bd==1?'true':'false'}"                   displayValue="<%=agent_b_name %>" readonly="true" id="lk_cust1" lookupUrl="/AgentAction.do?cmd=getAllagentByCondition" dialogTitle="选择合同乙方" height="430" width="680"/>
        ...
        <tr>
            ...
            <td class="td_2" nowrap="nowrap">
                 <w:date format="yyyy-MM-dd" id="contract_start_date" name="contract_start_date" property="bean/contract_start_date" width="189px" readOnly="true"/>
            </td>
