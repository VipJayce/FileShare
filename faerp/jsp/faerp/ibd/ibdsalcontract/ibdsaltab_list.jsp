...
function insert_onClick(gapwf){  //插入单条数据
 ...
 var contract_stop_date=document.form_treebasic.contract_stop_date.value.trim();;
      ...
      if(document.getElementById("contract_name").value==null || document.getElementById("contract_name").value==""){
        alert("合同名称不能为空！");
        return;
      }
    ...
    <%if(contract_type_bd!=null&&!contract_type_bd.trim().equals("1")){%>
      ...
      if(contract_stop_date!=""&&contract_stop_date.length!=0){
                ...
                var action="<%=request.getContextPath()%>/Finout_contract_productAction.do?cmd=insert_ibdcontract";
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
        ...
        <tr>
            ...
            <td class="td_2 " nowrap="nowrap">
                <w:lookup onReturnFunc="rtnFunc" id="lk_cust" name="cust_name" lookupUrl="/CustomersimpleAction.do?cmd=getAllCustomerByCondition1"  dialogTitle="选择合同甲方" height="434" width="750" style="width:188px" displayValue="${customer_name}"/>
