...
<%  //判断是否为修改页面
	...
	if(request.getParameter("isModify") != null) {  //如果从request获得参数"isModify"不为空
		...
		if(request.getAttribute(ICertificateMaterialConstants.REQUEST_BEAN) != null) {  //如果request中取出的bean不为空
...
<script language="javascript">
	function insert_onClick(){  //插入单条数据
		form.action="<%=request.getContextPath()%>/CertificateMaterialAction.do?cmd=insert";
		form.submit();
	}
  	...
  	function update_onClick(id){  //保存修改后的单条数据
	    ...
	    form.action="<%=request.getContextPath()%>/CertificateMaterialAction.do?cmd=update";
    	form.submit();
	}

    function cancel_onClick(){  //取消后返回列表页面
        form.action="<%=request.getContextPath()%>/CertificateMaterialAction.do?cmd=queryAll&backFlag=true";
        form.submit();
    }
</script>
</head>
...
<tr><td> 
	<table class="table_div_content_inner">
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="credentials_id" inputName="员工证件信息表ID" value="" maxLength="9.5" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="credentials_materia_id" inputName="材料ID" value="" maxLength="9.5" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field_reference_readonly" name="receive_time" id="receive_time" inputName="接收时间" /><img class="refButtonClass"	src="<venus:base/>/images/icon/reference.gif" onClick="javascript:getYearMonthDay('receive_time','<venus:base/>/');"/>
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
		<tr>
			...
			<td align="left">
				<input type="text" class="text_field" name="status" inputName="状态" value="" maxLength="2.5" />
			</td>
			<td align="right"></td>
			<td align="left"></td>
		</tr>
