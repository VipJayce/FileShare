...
<title><fmt:message   key="examine_remark" /></title>
<script language="javascript">
    function save_onClick(){
        var remark = document.getElementById('examine_remark').innerHTML;
        ...
        returnAry[1] = document.getElementById('examine_remark').innerHTML;
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="td_2" width="85%">
                <textarea class="textarea_limit_words" cols="60" rows="5" id="examine_remark" name="examine_remark" inputName="备注" maxLength="1000"></textarea>
