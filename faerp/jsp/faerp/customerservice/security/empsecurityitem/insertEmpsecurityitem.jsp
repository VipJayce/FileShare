...
<%  //判断是否为修改页面
	...
	if(request.getParameter("isModify") != null) {  //如果从request获得参数"isModify"不为空
		...
		if(request.getAttribute(IEmpsecurityitemConstants.REQUEST_BEAN) != null) {  //如果request中取出的bean不为空
...
<script language="javascript">
	function insert_onClick(){  //插入单条数据
	    if(checkAllForms()){
		form.action="<%=request.getContextPath()%>/EmpsecurityitemAction.do?cmd=insert";
		form.submit();
		}
	}
  	...
  	function update_onClick(id){  //保存修改后的单条数据
	    ...
	    form.action="<%=request.getContextPath()%>/EmpsecurityitemAction.do?cmd=update";
    	form.submit();
    	}
	}
...
<table  width="100%" height="40" border="0" cellpadding="0" cellspacing="1" bgcolor="#c5dbe2">
		...
		<tr>
			...
			<td  class="td_2" >
				<input type="text" class="text_field" name="e_ratio" inputName="企业比例" maxLength="24" integerDigits="18" decimalDigits="5" />
			</td>
			<td class="td_2"></td>
			<td class="td_2" ></td>
		</tr>
		<tr>
			...
			<td  class="td_2" >
				<input type="text" class="text_field" name="p_ratio" inputName="个人比例" maxLength="24" integerDigits="18" decimalDigits="5" />
			</td>
			<td class="td_2"></td>
			<td class="td_2" ></td>
		</tr>
		...
		<tr>
			...
			<td class="td_2 ">
				<input type="text" class="text_field" name="product_ratio_id" inputName="产品比例ID" value="" maxLength="9.5" />
			</td>
			<td class="td_2" ></td>
			<td class="td_2" ></td>
		</tr>
		<tr>
			...
			<td  class="td_2" >
				<input type="text" class="text_field" name="exact_e_money" inputName="企业准确的金额" maxLength="23" integerDigits="18" decimalDigits="4" />
			</td>
			<td class="td_2"></td>
			<td class="td_2" ></td>
		</tr>
		<tr>
			<td  class="td_1" >企业准确的金额</td>
			<td  class="td_2" >
				<input type="text" class="text_field" name="exact_p_money" inputName="企业准确的金额" maxLength="23" integerDigits="18" decimalDigits="4" />
			</td>
			<td class="td_2"></td>
			<td class="td_2" ></td>
		</tr>
