...
function show_detail_onClick(){
    ...
    //showModalCenter(url, window, callBack, 1024, 450, "公积金查看");
}
...
function modify_onClick(){
    ...
    //showModalCenter(url, window, callBack, 1024, 450, "公积金修改");
}
...
<div id="right">
<script language="javascript">
    writeTableTopFesco('公积金修改','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
...
<div id="ccParent1" class="button"> 
                    ...
                    -->
                    <input class="a_2" type="button"   value=" 查看个人订单"  <au:authorityBtn code="view_orderItem23" type="1"/>  onClick="detail_onClick();">
                    <input class="a_2" type="button"   value=" 查看详细"  <au:authorityBtn code="gjjxg_item" type="1"/>  onClick="show_detail_onClick();">
                    <input class="bl_1" type="button"   value=" 修改"  <au:authorityBtn code="gjjxg_xg" type="1"/>  onClick="modify_onClick();">
                    <input class="f_1" type="button"   value=" 开户失败"  <au:authorityBtn code="gjjxg_khsb" type="1"/>  onClick="openFailed_onClick();">
...
<div style="padding: 8 10 8 8;">
    <r:datacell 
      ...
      <r:field fieldName="transact_man" sortAt="none" label="办理人" width="100px" allowModify="false">
            <h:text />      
      </r:field>
      ...
      <r:field fieldName="fund_month" sortAt="none" label="报表月" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      
      <r:field fieldName="pay_base" sortAt="none" label="基数" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      
      <r:field fieldName="security_status_bd" sortAt="none" label="状态" width="100px" allowModify="false">
            <d:select dictTypeId="SECURITY_STATUS_BD" nullLabel="--请选择--"/>      
      </r:field>
      
      <r:field fieldName="stop_date" sortAt="none" label="停办日期" width="100px" allowModify="false">
            <w:date format="yyyy-MM-dd" name="stop_date" size="6"/>  
      </r:field>
      
      <r:field fieldName="stop_man" sortAt="none" label="停办人" width="100px" allowModify="false">
            
      </r:field>
      
      <r:field fieldName="stop_reason_bd" sortAt="none" label="停办原因" width="100px" allowModify="false">
