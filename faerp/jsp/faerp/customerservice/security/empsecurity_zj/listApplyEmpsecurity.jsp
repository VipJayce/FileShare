...
<div id="ccParent1" class="button"> 
 <div class="button_right">
         ...
         -->
 <input class="a_2" type="button"   value="查看个人订单"  <au:authorityBtn code="view_orderItem8" type="1"/>  onClick="detail_onClick();">    
 <input class="bl_1" type="button"   value="申请办理"  <au:authorityBtn code="sbsq_sqbl" type="1"/>  onClick="apply_onClick();">  
 <input class="nbl" type="button"   value="不需办理"  <au:authorityBtn code="sbsq_bxbl" type="1"/>  onClick="back_onClick();">  
 <input class="e" type="button"   value="导出"  <au:authorityBtn code="sbsq_exp" type="1"/>  onClick="exportExcel_onClick();">       
         </div>
           <div class="clear"></div>            
</div>
