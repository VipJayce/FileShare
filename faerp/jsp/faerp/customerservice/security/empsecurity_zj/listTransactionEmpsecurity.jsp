...
//导出excel
    function exportExcel_onClick(){  //导出Excel
      ...
      // var stopType=document.getElementById("stopType").value;
        ...
        form.action="<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=exportExcel1&queryType="+queryType+"&stopType="+""+"&group_id="+security_group_id;
...
%>
   writeTableTopFesco('社保办理','<%=request.getContextPath()%>/');  //显示本页的页眉
...
<div id="ccParent1" class="button"> 
                    ...
                    -->
                    <input class="a_2" type="button"   value="查看个人订单"  <au:authorityBtn code="view_orderItem9" type="1"/>  onClick="detail_onClick();">  
                    <input class="bl_1" type="button"   value="进入办理"  <au:authorityBtn code="sbbl_jrbl" type="1"/>  onClick="in_Transaction_onClick();">  
                    <input class="pl" type="button"   value="批量退回申请"  <au:authorityBtn code="sbbl_plthsq" type="1"/>  onClick="batch_back_onClick();">  
                    <input class="h_1" type="button"   value="批量办理"  <au:authorityBtn code="sbbl_plbl" type="1"/>  onClick="batch_transaction_onClick();">  
                    <input class="h_1" type="button"   value="不需办理"  <au:authorityBtn code="sbbl_bxbl" type="1"/>  onClick="batch_cancel_onClick();">  
                    <input class="bc" type="button"   value="保存"  <au:authorityBtn code="sbbl_save" type="1"/>  onClick="save_onClick();">  
                    <input class="e" type="button"   value="导出"  <au:authorityBtn code="sbbl_exp" type="1"/>  onClick="exportExcel_onClick();">  
                    </div>
                </div>                    
<div style="padding: 8 10 8 8;">
    <r:datacell 
      ...
      <r:field fieldName="group_name" sortAt="none" label="社保组" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      ...
      <r:field fieldName="serial_no" sortAt="none" label="序号" width="100px" allowModify="false">
            <h:text />      
      </r:field>
      ...
      <r:field fieldName="pension_base" sortAt="none" label="养老保险基数" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      
      <r:field fieldName="pension_e_ratio" sortAt="none" label="企业比例" width="100px" allowModify="false">
            <h:text/>      
      </r:field>

      <r:field fieldName="pension_p_ratio" sortAt="none" label="个人比例" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      
      <r:field fieldName="medical_base" sortAt="none" label="医疗保险基数" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      
      <r:field fieldName="medical_e_ratio" sortAt="none" label="企业比例" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      
      <r:field fieldName="medical_p_ratio" sortAt="none" label="个人比例" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      ...
      <r:field fieldName="disease_base" sortAt="none" label="大病保险基数" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      
      <r:field fieldName="disease_e_ratio" sortAt="none" label="企业比例" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
      
      <r:field fieldName="disease_p_ratio" sortAt="none" label="个人比例" width="100px" allowModify="false">
            <h:text/>      
      </r:field>
    </r:datacell>
    </div>
