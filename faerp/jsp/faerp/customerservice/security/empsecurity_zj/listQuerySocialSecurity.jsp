...
<script language="javascript">
	...
	function detail_Click(){
	   var securityId = document.getElementById("securityId").value;
        ...
        window.open('<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=detailQuerySocialSecurity&securityId=' + securityId+'&types=social_security','详细信息','height=600px,width=1024px,top=100,left=200,help=no,resizable=yes,scrollbars=yes,location=no,status=no');
...
<script language="javascript">
writeTableTopFesco('社保查询','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
...
<!--        <tr>-->
        ...
        <tr>
          ...
          <td align="left">
                <w:lookup name="cust_name1" onReturnFunc="rtnFuncCustomer" readonly="false" id="lk_clz" lookupUrl="/CustomersimpleAction.do?cmd=getAllCustomerByCondition" dialogTitle="选择客户" height="440" width="600"  style="width:195px"/>
           </td>
        </tr>
        <tr>
...
<div id="ccParent1" class="button"> 
 <div class="button_right">
		 ...
		 -->
		 <input class="a_2" type="button"   value="查看个人订单"  <au:authorityBtn code="view_orderItem13" type="1"/>  onClick="detail_onClick();">  
         <input class="a" type="button"   value="查看"  <au:authorityBtn code="sbcx_view" type="1"/>  onClick="detail_Click();">  
         <input class="e" type="button"   value="导出"  <au:authorityBtn code="sbcx_exp" type="1"/>  onClick="exportToExcel();">  
		 </div>
           <div class="clear"></div>			
</div>
