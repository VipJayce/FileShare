...
<title>无标题文档</title>
 <script  language="javascript">
    var tabs;
     ...
     if(security_type=='1'){
              tabs  =  new Array( 
            new Array ("生成支付","<%=request.getContextPath()%>/jsp/faerp/customerservice/security/empsecurity_zj/listSecurityPay.jsp?group_type=1&security_type=1"),
            new Array ("支付查询","<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=listSecurityFindZj")
        );
     }else{
           tabs  =  new Array(   ///EmpsecurityAction.do?cmd=queryAll
               new Array ("生成支付","<%=request.getContextPath()%>/jsp/faerp/customerservice/security/empsecurity_zj/listSecurityPay.jsp?group_type=2&security_type=2"),
      //       new Array ("生成支付","<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=listshebaoPay"),
            new Array ("支付查询","<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=listshebaoFindZj")
        );
