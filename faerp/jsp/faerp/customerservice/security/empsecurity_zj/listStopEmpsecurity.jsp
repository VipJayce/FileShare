...
//导出excel
    function exportExcel_onClick(){  //导出Excel
       ...
       var stopType=document.getElementById("stopType").value;
        ...
        form.action="<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=exportExcel&queryType="+queryType+"&stopType="+stopType+"&group_id="+security_group_id;
...
%>
   writeTableTopFesco('社保停办','<%=request.getContextPath()%>/');  //显示本页的页眉
...
<!--                    <d:select name="hire_fire_status" dictTypeId="HIRE_FIRE_STATUS_BD"  nullLabel="--请选择--" style="width: 205px"/>-->
        ...
        <tr>
           <td align="right">停缴原因&nbsp;&nbsp;</td>
            <td align="left">
                    <d:select name="stopType"  id="'stopType" dictTypeId="STOP_TYPE" nullLabel="--请选择--" style="width: 205px"/>
            </td>
            ...
            <td align="left">
                <w:date format="yyyy-MM-dd" name="the_end_date_from" size="8"/>到<w:date format="yyyy-MM-dd" name="the_end_date_to" size="8" />
            </td>
...
<div id="ccParent1" class="button"> 
                    ...
                    -->
                     <input class="a_2" type="button"   value="查看个人订单"  <au:authorityBtn code="view_orderItem10" type="1"/>  onClick="detail_onClick();">  
                    <input class="a_2" type="button"   value="查看详细"  <au:authorityBtn code="sbtb_viewItem" type="1"/>  onClick="show_detail_onClick();">  
                    <input class="bl_1" type="button"   value="停办"  <au:authorityBtn code="sbtb_tb" type="1"/>  onClick="stop_onClick();">  
                    <input class="e" type="button"   value="导出"  <au:authorityBtn code="sbtb_exp" type="1"/>  onClick="exportExcel_onClick();">  
                    </div>
                </div>                    
<div style="padding: 8 10 8 8;">
    <r:datacell 
      ...
      <r:field fieldName="stop_type_name" sortAt="none" label="停办类型" width="100px" >
            <h:text />      
      </r:field>
    ...
    $id("datacell1").beforeEdit=function(cell,colIndex,rowIndex){
        ...
        if (colIndex == 13){
            if (!$id("new_service_List" + colIndex) || eos_orgEditor == null){
                ...
                var htmlString ="" ;
                htmlString += "<div id=\"new_service_List13_container\"  class=\"eos-ic-container\" >";
                htmlString += "<input class=\"eos-combo-select-editor-text\" type=\"text\" id=\"new_service_List13_input\" /><img id='new_service_List13_button' class='eos-ic-button'  /><input type=\"hidden\" id=\"new_service_List13_hidden\" name=\"new_service_List13\" />";
                htmlString += "</div>";
