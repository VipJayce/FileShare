...
function citySecurityGroupchange(seletvalue){
	...
	function toAdd_onClick() {  //到增加记录页面
	    var group_type= document.getElementById('group_type').value;
	    var security_type= document.getElementById('security_type').value;
		var url="<%=request.getContextPath()%>/jsp/faerp/customerservice/security/socialaccountpvd/insertSocialaccountpvd.jsp?group_type="+group_type+"&security_type="+security_type;
        url=url+'&_ts='+(new Date()).getTime();   //防止IE缓存，在每次打开时加个时间差的参数
...
<input type="hidden" name="security_type" id="security_type" value="${security_type}">
...
<div id="ccParent1" class="button"> 
 <div class="button_right">
		 ...
		 -->
		 <input class="a" type="button"   value="<fmt:message key="view"/>"  <au:authorityBtn code="sbzh_view1" type="1"/>  onClick="detail_onClick();">
         <input class="c" type="button"   value="<fmt:message key="insert"/>"  <au:authorityBtn code="sbzh_add1" type="1"/>  onClick="toAdd_onClick();">
         <input class="d" type="button"   value="<fmt:message key="delete"/>"  <au:authorityBtn code="sbzh_del1" type="1"/>  onClick="deleteMulti_onClick();">
         <input class="b" type="button"   value="<fmt:message key="modify"/>"  <au:authorityBtn code="sbzh_modify1" type="1"/>  onClick="findCheckbox_onClick();">
         </div>
		 </div>
           <div class="clear"></div>			
</div>
