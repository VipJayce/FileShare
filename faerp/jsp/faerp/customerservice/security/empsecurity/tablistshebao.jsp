...
<html>
<fmt:bundle basename='rayoo.customerservice.custservice.security.empsecurity.tablistshebao_resource' prefix='auto.'>
<head>
...
<title><fmt:message key='tablistshebao0000'/></title>
 <script  language="javascript">
    var tabs;
     function updateData() { //定义修改状态时显示的标签页
        tabs  =  new Array(   ///EmpsecurityAction.do?cmd=queryAll
            new Array ("<fmt:message key='tablistshebao0001'/>","<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=listshebaoPay"),
            new Array ("<fmt:message key='tablistshebao0002'/>","<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=listshebaoFind")
        );
