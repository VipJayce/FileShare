...
<fmt:bundle basename='rayoo.customerservice.custservice.security.empsecurity.listSHZongBaoFind_resource' prefix='auto.'>
<head>
...
<script language="javascript">
 ...
 function init(){
    ...
    document.form.fund_month1.value=yearmonth;
        ...
        //<fmt:message key='listSHZongBaoFind0019'/>查询条件
    function getbyid(){
    ...
    function setCheckboxStatus(value,entity,rowNo,cellNo){
       return "<input type='radio'  name='temp'   );>";  
        ...
        function showListData(){
            ...
            //            alert("<fmt:message key='listSHZongBaoFind0006'/>不能为空！");
           //             return;
           //          }
                    if(fund_month1==null||fund_month1==""){
                        alert("<fmt:message key='listSHZongBaoFind0007'/>不能为空！");
                        return;
                    }
...
<table width="100%" height="40" border="0" cellpadding="0"
                ...
                <tr>
                                    <td class="td_1"><fmt:message key='listSHZongBaoFind0004'/></td>
                                    <td class="td_2">
                                       <select id="security_group_id" name="security_group_id">
                                          <option value="<%=IEmpsecurityConstants.SECURITY_GROUP_ID4 %>"   selected="selected"><fmt:message key='listSHZongBaoFind0005'/></option>
                                       </select>
                                    </td>
                                   <td class="td_1"><fmt:message key='listSHZongBaoFind0006'/></td>
        ...
        <tr>
             <td class="td_1"><fmt:message key='listSHZongBaoFind0007'/></td>
                    <td class="td_2"><input type="text" class="text_field"  id="fund_month1"    name="fund_month1" inputName="<fmt:message key='listSHZongBaoFind0007'/>" maxLength="6" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" /></td>
                     <td class="td_1"><fmt:message key='listSHZongBaoFind0009'/></td>
                    <td class="td_2">
        ...
        <tr>
                     <td class="td_1"><fmt:message key='listSHZongBaoFind0011'/></td>
                    <td class="td_2">
                     ...
                     <td class="td_1">应支付查询<fmt:message key='listSHZongBaoFind0020'/></td>
                    <td class="td_2"><select name="status" class="sSelect" id="status">
                       <option value="1" selected="selected"><fmt:message key='listSHZongBaoFind0014'/></option>
                      <option value="2"><fmt:message key='listSHZongBaoFind0015'/></option>
                      <option value="3"><fmt:message key='listSHZongBaoFind0016'/></option>
                    </select></td>
        </tr>
     ...
     <div class="button_right">
                <ul>
                      <li class="e">      <a  onclick="exportEmpSend();"><fmt:message key='listSHZongBaoFind0017'/></a> </li>
                </ul>
     </div>
     <div class="clear"></div>     
...
<div style="padding: 8 10 8 8;">
    <r:datacell 
       ...
       <r:field fieldName="customer_code" messagekey='listSHZongBaoFind0018' width="100px">
       </r:field>   
       <r:field fieldName="customer_name" width="340px" messagekey='listSHZongBaoFind0019'>
      </r:field>
       <r:field fieldName="status" messagekey='listSHZongBaoFind0020'  allowModify="false">
      </r:field>
    </r:datacell>
