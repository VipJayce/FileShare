...
<html>
<fmt:bundle basename='rayoo.customerservice.custservice.security.empsecurity.listshebaoFind_resource' prefix='auto.'>
<head>
...
function toConfi_onClick(){
 ...
 if(null==id||id==""){
 alert("<fmt:message key='listshebaoFind0000'/>");
 return;
 }
  ...
  form.submit();
        ...
        //<fmt:message key='listshebaoFind0019'/>查询条件
    function getbyid(){
  ...
  //       $id("product_id").queryParam= "<param><key>security_group_id</key><value>" + value + "</value><key>city_id</key><value>" + value1 + "</value></param>";
		...
		//	 	        alert("<fmt:message key='listshebaoFind0008'/>不能为空！");
		//	 	        return;
		// 		    }
			 	    
				    if(fund_month1==null||fund_month1==""){
                        alert("<fmt:message key='listshebaoFind0002'/>");
                        return;
                    }
...
<table width="100%" height="40" border="0" cellpadding="0"
                ...
                <tr>
                                    <td class="td_1"><fmt:message key='listshebaoFind0005'/></td>
                                    <td class="td_2">
                                       <select id="security_group_id" name="security_group_id">
                                           <option value="1099110700000000155"  selected="selected"><fmt:message key='listshebaoFind0006'/></option>
                                           <option value="1099110700000000156"  ><fmt:message key='listshebaoFind0007'/></option>
                                       </select>
                                    </td>
                                   <td class="td_1"><fmt:message key='listshebaoFind0008'/></td>
        ...
        <tr>
             <td class="td_1"><fmt:message key='listshebaoFind0009'/></td>
                    <td class="td_2"><input type="text" class="text_field"  id="fund_month1"   name="fund_month1" inputName="<fmt:message key='listshebaoFind0009'/>" maxLength="6" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" /></td>
                     <td class="td_1"><fmt:message key='listshebaoFind0011'/></td>
                    <td class="td_2">
        ...
        <tr>
                     <td class="td_1"><fmt:message key='listshebaoFind0013'/></td>
                    <td class="td_2">
                     ...
                     <td class="td_1"><fmt:message key='listshebaoFind0015'/></td>
                    <td class="td_2"><select name="status" class="sSelect" id="status">
                      <option value="1" selected="selected"><fmt:message key='listshebaoFind0016'/></option>
                      <option value="2"><fmt:message key='listshebaoFind0017'/></option>
                      <option value="3"><fmt:message key='listshebaoFind0018'/></option>
                    </select></td>
        </tr>
        <tr>
                     <td class="td_1"><fmt:message key='listshebaoFind0019'/></td>
                    <td class="td_2">
                        <input type="text" name="custName" id="custName" class="text_field">          
                    </td>
                     <td class="td_1"><fmt:message key='listshebaoFind0020'/></td>
 ...
 <input type="hidden" id="isClickQuery" value="false" />
     <div class="button_right">
                <ul>
                      <li class="e">      <a  onclick="exportEmpSend();"><fmt:message key='listshebaoFind0021'/></a> </li>
                </ul>
     </div>
     <div class="clear"></div>     
<div style="padding: 8 10 8 8;">
    <r:datacell 
       ...
       <r:field fieldName="customer_code" messagekey='listshebaoFind0020' width="100px">
       </r:field>   
       <r:field fieldName="customer_name" width="340px" messagekey='listshebaoFind0019'>
      </r:field>
       <r:field fieldName="get_day" messagekey='listshebaoFind0024'  allowModify="false">
      </r:field>
    </r:datacell>
    </div>
