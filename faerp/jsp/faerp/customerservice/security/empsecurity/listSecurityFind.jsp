...
<fmt:bundle basename='rayoo.customerservice.custservice.security.empsecurity.listSecurityFind_resource' prefix='auto.'>
<head>
...
<script language="javascript">
 ...
 function init(){
    ...
    document.form.fund_month1.value=yearmonth;
        ...
        //<fmt:message key='listSecurityFind0017'/>查询条件
    function getbyid(){
    ...
    function setCheckboxStatus(value,entity,rowNo,cellNo){
       return "<input type='radio'  name='temp'   );>";  
        ...
        function showListData(){
            ...
            //            alert("<fmt:message key='listSecurityFind0000'/>");
           //             return;
           //          }
                    if(fund_month1==null||fund_month1==""){
                        alert("<fmt:message key='listSecurityFind0001'/>");
                        return;
                    }
...
<table width="100%" height="40" border="0" cellpadding="0"
                ...
                <tr>
                                    <td class="td_1"><fmt:message key='listSecurityFind0004'/></td>
                                    <td class="td_2">
                                       <select id="security_group_id" name="security_group_id">
                                          <option value="<%=IEmpsecurityConstants.SECURITY_GROUP_ID %>"   selected="selected"><fmt:message key='listSecurityFind0005'/></option>
                                       </select>
                                    </td>
                                   <td class="td_1"><fmt:message key='listSecurityFind0006'/></td>
        ...
        <tr>
             <td class="td_1"><fmt:message key='listSecurityFind0007'/></td>
                    <td class="td_2"><input type="text" class="text_field"  id="fund_month1"    name="fund_month1" inputName="<fmt:message key='listSecurityFind0007'/>" maxLength="6" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" /></td>
                     <td class="td_1"><fmt:message key='listSecurityFind0009'/></td>
                    <td class="td_2">
                       ...
                       xpath="CustServiceVo"
                       width="200px"
                       messagekey='listSecurityFind0010'
        ...
        <tr>
                     <td class="td_1"><fmt:message key='listSecurityFind0011'/></td>
                    <td class="td_2">
                     ...
                     <td class="td_1"><fmt:message key='listSecurityFind0013'/></td>
                    <td class="td_2"><select name="status" class="sSelect" id="status">
                       <option value="1" selected="selected"><fmt:message key='listSecurityFind0014'/></option>
                      <option value="2"><fmt:message key='listSecurityFind0015'/></option>
                      <option value="3"><fmt:message key='listSecurityFind0016'/></option>
                    </select></td>
        </tr>
        <tr>
                     <td class="td_1"><fmt:message key='listSecurityFind0017'/></td>
                    <td class="td_2">
                        <input type="text" name="custName" id="custName" class="text_field">          
                    </td>
                     <td class="td_1"><fmt:message key='listSecurityFind0018'/></td>
     ...
     <div class="button_right">
                <ul>
                      <li class="e">      <a  onclick="exportEmpSend();"><fmt:message key='listSecurityFind0019'/></a> </li>
                </ul>
     </div>
     <div class="clear"></div>     
...
<div style="padding: 8 10 8 8;">
    <r:datacell 
       ...
       <r:field fieldName="customer_code" messagekey='listSecurityFind0018' width="100px">
       </r:field>   
       <r:field fieldName="customer_name" width="340px" messagekey='listSecurityFind0017'>
      </r:field>
       <r:field fieldName="status" messagekey='listSecurityFind0022'  allowModify="false">
      </r:field>
    </r:datacell>
