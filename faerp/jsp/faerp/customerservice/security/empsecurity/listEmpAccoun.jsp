...
<fmt:bundle basename="gap.rm.rm_resource" prefix="gap.rm.">
    <fmt:bundle basename='rayoo.customerservice.custservice.security.empsecurity.listEmpAccoun_resource' prefix='auto.'>
<head>
    <base target="_self"/>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title><fmt:message key='listEmpAccoun0000'/></title>
    ...
    obj = dc.getActiveEntity();
        if(!obj){
           alert("<fmt:message key='listEmpAccoun0001'/>");
           return;
        }
     return obj;
    }
    ...
    <div class="clear"></div>
                          ...
                          <r:field fieldName="account" messagekey='listEmpAccoun0002' width="150px">
                            <h:text />
                          </r:field>
                        </r:datacell>
