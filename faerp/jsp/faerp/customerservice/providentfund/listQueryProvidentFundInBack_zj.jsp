...
<div id="right">
<script language="javascript">
writeTableTopFesco('公积金补缴查询','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
...
<div id="ccParent1" class="button"> 
 <div class="button_right">
		 ...
		 -->
		  <input class="a" type="button"   value=" 查看"  <au:authorityBtn code="bjcx_view" type="1"/>  onClick="detail_Click();">
         <input class="e" type="button"   value=" 导出"  <au:authorityBtn code="bjcx_exp" type="1"/>  onClick="exportToExcel();">
		 </div>
           <div class="clear"></div>			
</div>
