...
<script language="javascript">
	...
	function detail_Click(){
	   ...
	   var securityId = document.getElementById("securityId").value;
        ...
        var url="<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=detailQueryInBack&supplyId=" + supplyId+"&securityId="+securityId+"&types=complex_insurance_in_back";
        ...
        //$id("datacell_formid").action="<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=detailQueryInBack&supplyId=" + supplyId+"&securityId="+securityId+"&types=complex_insurance_in_back";
       // $id("datacell_formid").submit();
	}
	
	//导出
    function exportToExcel(){
        $id("datacell_formid").action="<%=request.getContextPath()%>/EmpsecurityAction.do?cmd=exportQueryInBackToExcel&para=complex_insurance_in_back";
        $id("datacell_formid").submit();
    }
...
<div id="right">
<script language="javascript">
writeTableTopFesco('综保补缴查询','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
<div class="ringht_s">
...
<div id="ccParent1" class="button"> 
 ...
 <div style="padding: 8 10 8 8;">
    <r:datacell 
        id="datacell1"
        queryAction="/FAERP/EmpsecurityAction.do?cmd=listQueryComplexInsuranceInBack"
        width="98%"
        height="320px"
