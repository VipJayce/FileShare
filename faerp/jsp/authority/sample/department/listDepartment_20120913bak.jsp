	...
	<tr>
		<td>
			<table class="table_noFrame" width="100%">
				<tr>
					<td width="15%" align="right"><fmt:message key='gap.authority.Department_Code' bundle='${applicationAuResources}' /></td>
					<td width="35%" align="left">
						<input type="text" class="text_field" validate="isSearch" name="dept_no" inputName="<fmt:message key='gap.authority.Department_Code' bundle='${applicationAuResources}' />" maxLength="50"/>
					</td>
...
<table class="table_div_content2" width="100%">
	<tr>
		...
		<layout:collection name="beans" id="rmBean" styleClass="listCss" width="100%" indexId="orderNumber" align="center" sortAction="0">
			...
			<layout:collectionItem width="160" title='<%=venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Number") %>' property="dept_no"/>
			<layout:collectionItem title='<%=venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Department_name") %>' property="dept_name"/>
			<layout:collectionItem width="60" title='<%=venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Department_logo") %>' property="dept_flag"/>
			<layout:collectionItem width="100" title='<%=venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Person_in_charge") %>' property="dept_leader"/>
