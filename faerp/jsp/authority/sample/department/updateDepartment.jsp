...
<script language="javascript">
	function insert_onClick(){  //插入单条数据
  	...
  	function update_onClick(id){  //保存修改后的单条数据
	    ...
	    form.action="<%=request.getContextPath()%>/DepartmentAction.do?cmd=updates";
	    var parentRelId = form.parentRelId.value;
    	if(parentRelId!="")
    		form.target="_parent";
    	form.submit();
			...
			<table class="table_div_content_inner">
				<tr>
					...
					<td width="70%" align="left">
						<input type="text" class="text_field" name="dept_name" readonly="readonly" style="color:#AAAAAA" inputName="<fmt:message key='gap.authority.Department_name' bundle='${applicationAuResources}' />" validate="notNull;isSearch;" value="" maxLength="300" />
					</td>
				</tr>
				<%
				...
				<tr>
					...
					<td align="left">
						<input type="text" class="text_field" name="dept_flag" readonly="readonly"  style="color:#AAAAAA" inputName="<fmt:message key='gap.authority.Department_logo' bundle='${applicationAuResources}' />" validate="isSearch;" value="" maxLength="50" />
					</td>
				</tr>
				<tr>
					<td align="right"><fmt:message key='gap.authority.Department_Type' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field" name="dept_type" readonly="readonly" style="color:#AAAAAA" inputName="<fmt:message key='gap.authority.Department_Type' bundle='${applicationAuResources}' />" validate="isSearch;" value="" maxLength="50" />
					</td>
				</tr>
				<tr>
                    <td align="right"><fmt:message key='gap.authority.Department_Code' bundle='${applicationAuResources}' /></td>
                    <td align="left">
                        <input type="text" class="text_field" name="dept_number" inputName="<fmt:message key='gap.authority.Department_Code' bundle='${applicationAuResources}' />" validate="isSearch;" value="" maxLength="50" />
                    </td>
                </tr>
				<tr>
					<td align="right"><fmt:message key='gap.authority.Sectoral_level' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field" name="dept_level" readonly="readonly" style="color:#AAAAAA" inputName="<fmt:message key='gap.authority.Sectoral_level' bundle='${applicationAuResources}' />" validate="isSearch;" value="" maxLength="1" />
					</td>
				</tr>
				<tr>
					<td align="right"><fmt:message key='gap.authority.Responsible_person' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field" name="dept_leader" readonly="readonly" style="color:#AAAAAA" inputName="<fmt:message key='gap.authority.Person_in_charge' bundle='${applicationAuResources}' />" validate="isSearch;" value="" maxLength="50" />
					</td>
				</tr>
				<!--tr>
