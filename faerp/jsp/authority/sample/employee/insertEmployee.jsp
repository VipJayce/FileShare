...
<script language="javascript">
	function insert_onClick(){  //插入单条数据
    	form.action="<%=request.getContextPath()%>/EmployeeAction.do?cmd=insert";
  	...
  	function update_onClick(id){  //保存修改后的单条数据
	    ...
	    form.action="<%=request.getContextPath()%>/EmployeeAction.do?cmd=update";
	    var parentRelId = form.parentRelId.value;
    	if(parentRelId!="")
    		form.target="_parent";
    	form.submit();
...
<body>
<script language="javascript">
	writeTableTop('<%=isModify?venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Modify_page"):venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.New_page")%>','<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
...
<table class="table_div_control">
	<tr> 
		<td>
			<img src="<%=request.getContextPath()%>/images/icon/07-0.gif" class="div_control_image" onClick="javascript:hideshow('ccChild1',this,'<%=request.getContextPath()%>/')"><%=isModify?venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Modify"):venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Added")%><%=venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Staff0")%>
		</td>
	</tr>
</table>
</div>
	...
	<tr>
		<td> 
			<table class="table_div_content_inner">
				<tr>
					<td width="30%" align="right"><span class="style_required_red">* </span><fmt:message key='gap.authority.Name1' bundle='${applicationAuResources}' /></td>
					<td width="70%" align="left">
						<input type="text" class="text_field" name="person_name" inputName="<fmt:message key='gap.authority.Name0' bundle='${applicationAuResources}' />" validate="notNull;isSearch;" value="" maxLength="50" />
					</td>
				</tr>
				<%
				...
				%>
				<tr>
					<td align="right"><span class="style_required_red">* </span><fmt:message key='gap.authority.Their_position_or_department_' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field_reference_readonly" id="owner_party_name" name="owner_party_name" inputName="<fmt:message key='gap.authority.Their_position_or_department_' bundle='${applicationAuResources}' />" maxlength="50" validate="notNull;"  
						...
						onClick="javascript: try {getTypeChooseTree(new Array('owner_party_id', 'owner_party_name'),'<venus:base/>','radio','','1','id','3','1','department,position'); }catch(e){alert('<fmt:message key='gap.authority.Insufficient_privileges' bundle='${applicationAuResources}' />')}"/>
					</td>
				</tr>
				<%
				}
				...
				<tr>
					<td align="right"><fmt:message key='gap.authority.English_name' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field" name="english_name" inputName="<fmt:message key='gap.authority.English_name0' bundle='${applicationAuResources}' />" validate="notChinese;isSearch;" value="" maxLength="50" />
					</td>
				</tr>
				<tr>
					<td align="right"><fmt:message key='gap.authority.Staff_Category' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field" name="person_type" inputName="<fmt:message key='gap.authority.Staff_Category' bundle='${applicationAuResources}' />" validate="isSearch;" value="" maxLength="50" />
					</td>
				</tr>
				<tr>
					<td align="right"><fmt:message key='gap.authority.Sex' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="radio" name="sex" inputName="<fmt:message key='gap.authority.Sex0' bundle='${applicationAuResources}' />" value="1" checked ><fmt:message key='gap.authority.Male' bundle='${applicationAuResources}' />
				...
				<tr>
					<td align="right"><fmt:message key='gap.authority.Mobile_telephone' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field" name="mobile" inputName="<fmt:message key='gap.authority.Mobile_telephone' bundle='${applicationAuResources}' />" validate="isMobile;" value="" maxLength="50"/>
					</td>
				</tr>
				<tr>
					<td align="right"><fmt:message key='gap.authority.Fixed_telephone' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field" name="tel" inputName="<fmt:message key='gap.authority.Fixed_telephone' bundle='${applicationAuResources}' />" validate="isTel;" value="" maxLength="50" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="right"><fmt:message key='gap.authority.Contact_Address' bundle='${applicationAuResources}' /></td>
					<td align="left">
						<input type="text" class="text_field" name="address" inputName="<fmt:message key='gap.authority.Contact_Address' bundle='${applicationAuResources}' />" validate="isSearch;" value="" maxLength="300" />
					</td>
				</tr>
				<tr>
