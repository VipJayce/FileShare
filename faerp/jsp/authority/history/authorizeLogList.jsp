...
<script>
	...
	function simpleQuery_onClick(){
		form.action="<%=request.getContextPath()%>/HistoryLogAction.do?cmd=simpleQueryForLogFrame";
		form.submit();
	}
...
%>		
		...
		form.action="<venus:base/>/AuAuthorizeAction.do?cmd=saveOrgAuByRelId";
		form.submit();	
	}
...
<tr><td>
	<table class="table_noFrame" width="100%">
		<tr>
			...
			<td width="15%" align="right"><fmt:message key='gap.authority.Operation_Resource_Name' bundle='${applicationAuResources}' /></td>
			<td width="35%" align="left">
		...
		<tr>
			...
			<td  align="left">
				...
				<input name="del" type="button" id="del" value="<fmt:message key='gap.authority.Empty' bundle='${applicationAuResources}' />" class="button_ellipse" onClick="javascript:clearParameter();">
			</td>
		</tr>		
	</table>
...
<table class="table_div_content">
	<tr>
		...
		<layout:collection name="beans" id="wy1" styleClass="listCss" width="100%" indexId="orderNumber" align="center" sortAction="0" >
			...
			<layout:collectionItem  title='<%=venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Operating_time") %>' property="operate_date" />
			<layout:collectionItem width="60" title='<%=venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Action_Type") %>' style="text-align:center;">
