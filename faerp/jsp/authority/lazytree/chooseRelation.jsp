...
<table class="table_div_content2" width="100%">
    <tr>
        ...
        <tr><th></th><th><fmt:message key='gap.authority.Type_of_relationship' bundle='${applicationAuResources}' /></th><th><fmt:message key='gap.authority.Name_of_relationship' bundle='${applicationAuResources}' /></th></tr>
<%
