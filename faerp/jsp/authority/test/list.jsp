...
<%@ page import="gap.authority.service.test.util.IConstants"%>
<%@ page import="gap.authority.service.test.vo.TestVo"%>
...
function viewDetail(obj) {  //显示权限页面
	window.location="<venus:base/>/TestAction.do?cmd=queryAll&tablename="+obj;
}
</script>
</head>
<body>
...
<form name="form" method="post"	action="<venus:base/>/TestAction.do">
...
<table class="table_div_control">
	<tr>
		<td><img src="<venus:base/>/images/icon/07-0.gif"
			...
			onClick="javascript:hideshow('ccChild0',this,'<venus:base/>/')">&nbsp;<fmt:message key='gap.authority.Table_name' bundle='${applicationAuResources}' />
		</td>
	</tr>
</table>
</div>
...
<tr>
<td><fmt:message key='gap.authority.Select_the_table_name' bundle='${applicationAuResources}' />
...
<table class="table_div_control">
	<tr>
		<td><img src="<venus:base/>/images/icon/07-0.gif"
			class="div_control_image"
			onClick="javascript:hideshow('ccChild1',this,'<venus:base/>/')">&nbsp;<fmt:message key='gap.authority.Field_name' bundle='${applicationAuResources}' />
		</td>
	</tr>
</table>
</div>
