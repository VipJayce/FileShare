...
<table class="table_noFrame" width="100%">
  ...
  <tr> 
     <td valign="top" width="100%"> 
     	<input type="hidden" name="orgTreeSrc" id="orgTreeSrc" value="<%=request.getContextPath()%>/jsp/authority/tree/deeptree4AuOrg.jsp?inputType=checkbox&submitType=submitAll&nodeRelationType=noRelation&relId=<%=request.getParameter("relId")%>&pType=<%=request.getParameter("pType")%>&rootXmlSource=<%=gap.authority.util.StringHelperTools.encodeUrl(rootXmlSource+firstParentCode)%>">
     	<!--树开始--> 
