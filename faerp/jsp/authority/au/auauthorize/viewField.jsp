...
<!--菜单树开始-->   
		...
		<script language="javascript">
			if (document.getElementById){
				//根节点
				var t0=new WebFXTree('<b><fmt:message key='gap.authority.Field_Resources' bundle='${applicationAuResources}' /></b>','');
...
%>
						var node<%=vo.getTable_name()%> = new WebFXTreeItem("<%=vo.getTable_chinesename()%>","<%="<fmt:message key='gap.authority.Table_name' bundle='${applicationAuResources}' />:"+vo.getTable_name()+";<fmt:message key='gap.authority.Table_Chinese_name' bundle='${applicationAuResources}' />:"+vo.getTable_chinesename()%>","<%=vo.getTable_name()%>","",new Array(0),new Array(0),new Array(0),new Array(0),"");
