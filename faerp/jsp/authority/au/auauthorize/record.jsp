...
<!--菜单树开始-->   
		...
		<script language="javascript">
			if (document.getElementById){
				//根节点
				var t0=new WebFXTree('<b><fmt:message key='gap.authority.Record_Resources' bundle='${applicationAuResources}' /></b>','',selTxtArray,selValArray);
...
%>
				...
				"<%="<fmt:message key='gap.authority.Field_name' bundle='${applicationAuResources}' />:"+vo.getField_name()+";<fmt:message key='gap.authority.Chinese_name_field' bundle='${applicationAuResources}' />:"+vo.getField_chinesename()+";<fmt:message key='gap.authority.Filter_Type' bundle='${applicationAuResources}' />:"+vo.getFilter_type()+";<fmt:message key='gap.authority.Filter_value' bundle='${applicationAuResources}' />:"+vo.getValue()+";<fmt:message key='gap.authority.Notes' bundle='${applicationAuResources}' />:"+vo.getHelp()%>",
