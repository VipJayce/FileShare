...
<%@ page import="gap.authority.au.appenddata.bs.IAppendDataBs"%>
<%@ page import="gap.authority.au.appenddata.vo.AuAppendVo"%>
...
try {
    ...
    IAuAuthorizeBS auAuthorizeBs = (IAuAuthorizeBS) Helper.getBean(gap.authority.au.auauthorize.util.IConstants.BS_KEY);
	...
	IAppendDataBs auBs = (IAppendDataBs) Helper.getBean(gap.authority.au.appenddata.util.IConstantsimplements.BS_KEY);
