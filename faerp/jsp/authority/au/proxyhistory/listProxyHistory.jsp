        ...
        <td>
            <table class="table_noFrame" width="100%">
                <tr>
                    ...
                    <td width="15%" align="right"><fmt:message key='gap.authority.Proxy0' bundle='${applicationAuResources}' /></td>
                    <td width="35%" align="left">
                        <input type="text" class="text_field" validate="isSearch" name="recipient" inputName="<fmt:message key='gap.authority.Proxy0' bundle='${applicationAuResources}' />" maxLength="50"/>
                    </td>
                </tr>
                <tr>
...
<input type="hidden" name="forwardPage" value="listPage">
</form>
<script language="javascript">
