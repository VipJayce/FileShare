...
<script> 
	function toAdd_onClick() {  //到增加记录页面
		window.location.href = "<venus:base/>/jsp/authority/au/aurole/insertAuRole.jsp";
	}
</script>
</head>
<body>
...
<!--						<img src="<%=request.getContextPath()%>/images/au/yq_bt<au:i18next/>.jpg" width="73" height="14">-->
						<br>
						<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key='gap.authority.Role_of_the_root_tree_has_not' bundle='${applicationAuResources}' /><br><br>
					</td>
				</tr>
				<br><br><br>
				<tr> 
