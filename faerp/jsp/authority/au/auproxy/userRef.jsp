...
<body>
<form name="form" method="post" action="<venus:base/>/AuProxyAction.do">
...
<tr>
	...
	<td width="20%" align="left"><input type="text" class="text_field_reference_readonly" validate="isSearch" name="department" inputName="<fmt:message key='gap.authority.Respective_organizations' bundle='${applicationAuResources}' />" maxLength="50" hiddenInputId="hid_department" value=""/><input type="hidden" name="hid_department"/><img class="refButtonClass" alt="<fmt:message key='gap.authority.Select_department' bundle='${applicationAuResources}' />" src="<venus:base/>/images/au/09.gif" onClick="javascript:getTree(new Array(hid_department, department),'<venus:base/>','radio','','1','','2','1');"/></td>		
