...
<!--
  	function update_onClick(){  //保存修改后的单条数据
	    ...
	    form.action="<%=request.getContextPath()%>/AuUserAction.do?cmd=forceModifyPassword";
    	form.submit();
	}
		...
		<td> 
			<table class="table_div_content_inner">
				...
				<tr>
                    ...
                    <td align="left">
                        <%if("1".equals(request.getParameter("changePwd"))){ %>
                            <input type="checkbox" name="seeagain" value="0" checked><fmt:message key='gap.authority.The_password_is_not_updated_when_the_show_this_page_again' bundle='${applicationAuResources}' />
                        <%} %>
                    </td>
                </tr>
            </table>
