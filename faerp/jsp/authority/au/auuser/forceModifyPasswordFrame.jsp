...
<%
	...
	if(successFlag != null) {
	    if(successFlag.equals("-1")) {
	        ...
	        out.print("<script language='javascript'>alert(\""+venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.New_password_and_old_password_can_not_be_the_same_")+"\");</script>");
