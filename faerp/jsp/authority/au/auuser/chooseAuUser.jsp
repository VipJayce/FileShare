...
<table class="table_noFrame">
	<tr>
		<td>
			<input name="button_save" class="button_ellipse" type="button" value="<fmt:message key='gap.authority.Save' bundle='${applicationAuResources}' />" onClick="javascript:insert_onClick();">
	...
	<tr>
		...
		<layout:collection name="wy" id="wy1" styleClass="listCss" width="100%" indexId="orderNumber" align="center" sortAction="0" >
 			...
 			<layout:collectionItem width="30" title="" style="text-align:center;">
				...
				&nbsp;<fmt:message key='gap.authority.Disable' bundle='${applicationAuResources}' />
				</logic:equal>
