...
<title><fmt:message key='gap.authority.Group_relations_view' bundle='${applicationAuResources}' /></title>
</head>
<body>
<script language="javascript">
	writeTableTop("<fmt:message key='gap.authority.Group_relations_view' bundle='${applicationAuResources}' />",'<%=request.getContextPath()%>/');  //显示本页的页眉
</script>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<table width="100%" height="380" border="0" align="center"
					cellpadding="0" cellspacing="1" bgcolor="#7EBAFF">
					<tr>
						<td bgcolor="#FFFFFF"><iframe id="leftTree" name="leftTree"
							width="100%" height="100%" frameborder="0"
							src="<venus:base/>/AuPartyRelationTypeAction.do?cmd=queryLeftTree"></iframe>
						</td>
					</tr>
				</table>
				</td>
