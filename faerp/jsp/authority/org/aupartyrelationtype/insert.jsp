...
<table class="table_div_control">
	<tr> 
		<td>
			<img src="<venus:base/>/images/icon/07-0.gif" class="div_control_image" onClick="javascript:hideshow('auDivChild1',this,'<venus:base/>/')"><%=isModify?venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Modify_the_relationship_between_body_type"):venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.New_types_of_group_relations")%>
		</td>
	</tr>
</table>
</div>
...
<table class="table_div_content">
	...
	<tr> 
		...
		<td align="left">
			<input name="name" type="text" class="text_field" inputName="<fmt:message key='gap.authority.Name' bundle='${applicationAuResources}' />" validate="notNull;isSearch" maxlength=50 value="">
		</td>
	</tr>	
	<%if(isModify) {%>
	<tr>
	...
	<%} else {%>
	<tr>
	    <td align="right" width="10%" nowrap><span class="style_required_red">* </span><fmt:message key='gap.authority.Classification' bundle='${applicationAuResources}' /></td>
	    <td align="left">
			<select name="keyword">
    ...
    <%} else {%>
	<tr>
        <td align="right" width="10%" nowrap><fmt:message key='gap.authority.RootPartyType' bundle='${applicationAuResources}' /></td>
        <td align="left">
            <input name="rootpartytypename" id="rootpartytypename" type="text" class="text_field_reference_readonly" maxlength=50 value=""><input name="root_partytype_id" id="root_partytype_id" type="hidden"><img class="refButtonClass" src="<venus:base/>/images/au/09.gif" onClick="javascript:toSel_onClick('rootpartytypename','root_partytype_id')"/>
        </td>       
    </tr>
    <%} %>
	<tr>
