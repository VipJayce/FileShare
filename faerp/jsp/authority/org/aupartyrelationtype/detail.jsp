...
<%
	...
	if(type_TypeName==null) 
	    type_TypeName=venus.frames.i18n.util.LocaleHolder.getMessage("gap.authority.Unknown");
...
<table class="table_noframe" width="97%" align="center">
	...
	<table border="1" bordercolordark="#FFFFFF" bordercolorlight="#7EBAFF" cellpadding="5" cellspacing="0" width="80%" align="center"> 	
		<tr> 
			<td colspan="2" align="center"><fmt:message key='gap.authority.Type_of_group_relations_in_detail' bundle='${applicationAuResources}' /></td> 
		</tr>
		<tr> 
		...
		<tr>
		  <td width="30%" align="right"><fmt:message key='gap.authority.Relationship_type_classification_' bundle='${applicationAuResources}' /></td>
		  <td width="70%" align="left" bgcolor="#FFFFFF">&nbsp;<%=type_TypeName%></td>
	   </tr>	
	   <tr>
          <td width="30%" align="right"><fmt:message key='gap.authority.RootPartyTypeDetail' bundle='${applicationAuResources}' /></td>
