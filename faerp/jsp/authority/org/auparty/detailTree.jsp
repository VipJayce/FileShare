...
<jsp:include page="<venus:base/>/jsp/authority/tree/include/globalDeepTree.jsp?nodeRelationType=noRelation" />
<title><fmt:message key='gap.authority.China_Netcom_Group_Co_Ltd_Hebei_Province_branch' bundle='${applicationAuResources}' /></title>
<script language="javascript">		
	...
	function returnValueName() {  //获得所有选择的checkbox
		...
		for(var i=0; i<submitStringArray.length; i++) {  //把要提交的checkbox属性填满放入submitObjectArray
			...
			tempObj["partyType"] = thisObj.detailedType;
