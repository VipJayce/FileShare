...
<table class="table_noframe">
	<tr>
		<td valign="middle">
			...
			<input name="button_cancel" type="button" class="button_ellipse" value="<fmt:message key='gap.authority.Cancel' bundle='${applicationAuResources}' />"  onClick="javascript:queryAll_onClick();">
		</td>
	</tr>
</table>
...
<table class="table_div_content">
	<tr> 
		...
		<td align="left">
			...
			<input name="name" type="text" class="text_field" inputName="<fmt:message key='gap.authority.Name' bundle='${applicationAuResources}' />" maxlength=50 validate="notNull;isSearch" value="">
		</td>		
	</tr>
	<tr>
	    <td align="right" width="10%" nowrap><span class="style_required_red">* </span><fmt:message key='gap.authority.Type_Classification' bundle='${applicationAuResources}' /></td>
	    <td align="left">
			<select name="keyword">
	...
	<!-- 
	<tr>
	    <td align="right" width="10%" nowrap><fmt:message key='gap.authority.Which_tables_mapping' bundle='${applicationAuResources}' /></td>
	    <td align="left">
			<input name="table_name" type="text" class="text_field" inputName="<fmt:message key='gap.authority.Which_tables_mapping' bundle='${applicationAuResources}' />" maxlength=50 value="">
		</td>
	</tr>	
	 -->
	<tr>
