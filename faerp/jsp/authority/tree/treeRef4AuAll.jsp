...
<table class="table_noFrame">
  <tr>
    <td width="30%" ><fmt:message key='gap.authority.Administrative_relations' bundle='${applicationAuResources}' /></td> 
    <td width="30%" ><fmt:message key='gap.authority.Role_relations' bundle='${applicationAuResources}' /></td> 
    <td width="30%" ><fmt:message key='gap.authority.Agent1' bundle='${applicationAuResources}' /></td> 
  </tr>
  <tr> 
