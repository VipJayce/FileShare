...
<%@ page import="gap.authority.org.aupartytype.bs.IAuPartyTypeBS"%>
		...
		*/
		for(Iterator it = lParty.iterator(); it.hasNext(); ) {
            ...
            if(!"{}".equals(attributesFilter)){
                String tableName = ((AuPartyTypeVo)((IAuPartyTypeBS)Helper.getBean(gap.authority.org.aupartytype.util.IConstants.BS_KEY)).find(partyTypeId)).getTable_name();
