...
<table>
	<tr>
		<td>
			<input type="button" name="Submit" value="<fmt:message bundle='${applicationResources}'  key="confirm"/>" class="button_ellipse" onclick="returnValue('referenceDetail','factory_Id','factory_name');">
...
<table id="tableData" class="listCss" width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <tr class="listCss">
		...
		<th class="listCss" width="40%"><img src="<%=request.getContextPath()%>/images/layout/sort.gif" border="0" alt="<fmt:message bundle='${applicationResources}'  key="asce"/>" onclick="javascript:pageVo.sortOrder(this,'name');"><fmt:message key="ordercontent.factory_name"/></th>
	</tr>
	</thead>
