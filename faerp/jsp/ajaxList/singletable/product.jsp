...
<form name="form" method="post" action="<venus:base/>/AjaxSingleTableAction.do?cmd=queryProduct">
...
<table>
	<tr>
		...
		<layout:collection name="factoryList" id="wy1" styleClass="listCss" width="98%" indexId="orderNumber" align="center" sortAction="0">
			...
			<layout:collectionItem width="180" title='<%=LocaleHolder.getMessage("gap.ajax.ordercontent.product_name")%>'  property="name" sortable="true"/>
		</layout:collection>
