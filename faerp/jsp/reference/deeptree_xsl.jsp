...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                ...
                <div>
                    <xsl:choose>
                        <xsl:when test="TreeNode">
                            <xsl:choose>
                                <xsl:when test="@defaultOpen &gt; 0">
                                    <xsl:attribute name="style"><xsl:value-of select="'padding-left:16px;display:block'"/></xsl:attribute>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:attribute name="style"><xsl:value-of select="'padding-left:16px;display:none'"/></xsl:attribute>
                                </xsl:otherwise>
                            </xsl:choose>
                            <xsl:attribute name="send">true</xsl:attribute>
                        </xsl:when>
    ...
    <xsl:template match="message">
        <div class="TreeNode" type="load" nowrap="true">
            <img type="img" src="../images/file.gif" align="absmiddle"/>
