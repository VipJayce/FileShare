...
<title><fmt:message key="filemanage.file_manage"/></title>
</head>
<body>
  ...
  <tr> 
    <td>&nbsp;&nbsp;</td>
      ...
      <table width="100%" height="460"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#7EBAFF">
        <tr> 
          <td bgcolor="#FFFFFF"> 
             <iframe id="report" name="report" width="100%" height="100%" frameborder="0" 
      ...
      <table width="95%"  height="460"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#7EBAFF" >
        <tr> 
          <td bgcolor="#FFFFFF" align="center">
				<iframe id="detailReportFile" name="detailReportFile"	style="HEIGHT:100%; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: 2" scrolling=auto frameborder=0 src="<%=request.getContextPath()%>/jsp/report/filemanage/default.jsp" ></iframe> 
			</iframe>
          </td>
        </tr>
      </table>
