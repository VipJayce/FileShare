...
<script language="javascript">
    writeTableTop('<fmt:message key="View_Job"/>','<venus:base/>/');
</script>
    ...
    <tr>
        ...
        <layout:collection name="jobList" id="jobDetail" styleClass="listCss" width="99%" indexId="orderNumber" align="center" sortAction="0">
            ...
            <layout:collectionItem width="3%" title="<input type='checkbox' pdType='control' control='checkbox_template'/>" style="text-align:center;">
                ...
                <input title="<%=LocaleHolder.getMessage("gap.quartz.job")+wy3%>" type="checkbox" name="checkbox_template" value="<%=wy3+","+wy4%>"/>
            ...
            <layout:collectionItem width="10%" title='<%=LocaleHolder.getMessage("gap.quartz.Job_Name")%>' property="name" sortable="true"/>
            <layout:collectionItem width="10%" title='<%=LocaleHolder.getMessage("gap.quartz.Job_Group")%>' property="group" sortable="true"/>
            <layout:collectionItem width="10%" title='<%=LocaleHolder.getMessage("gap.quartz.Job_Class")%>' property="jobClass" sortable="true"/>
            <layout:collectionItem width="10%" title='<%=LocaleHolder.getMessage("gap.quartz.Job_Description")%>' property="description" sortable="false"/>
        </layout:collection>        
