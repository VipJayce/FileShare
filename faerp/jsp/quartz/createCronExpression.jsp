...
<script language="javascript">
	writeTableTop('<fmt:message key="Reference_List"/>','<venus:base/>/');
</script>
...
<table class="table_div_control">
	<tr>
		<td>
			...
			<input type="button" name="cancel" value="<fmt:message key="Cancel"/>" class="button_ellipse" onClick="javascript:window.close();">
		</td>
	</tr>
</table>
</div>
