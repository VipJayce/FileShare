...
<script>
	...
	function deleteMulti_onClick(){  //从多选框物理删除多条记录
		...
		if(confirm("<fmt:message key='gap.message.It_completely_remove_the_data_' bundle='${applicationMessageResources}' />")) {
	    	form.action="<venus:base/>/MessageAction.do?cmd=deleteMessageWithUser&ids=" + ids+"&subject=MANAGER";
    		form.submit();
		}
	}
...
<script language="javascript">
	writeTableTop("<fmt:message key='gap.message.Check_list' bundle='${applicationMessageResources}' />",'<venus:base/>/');
</script>
...
<tr>
	...
	<td>
		<input name="messagetitle" type="text" class="text_field" inputName=<fmt:message key='gap.message.Title' bundle='${applicationMessageResources}' /> validate="isSearch">
	</td>
</tr>
<tr>
	<td align="right" width="10%" nowrap><fmt:message key='gap.message.From' bundle='${applicationMessageResources}' /></td>
	<td><input name="messagefrom" type="text" class="text_field" inputName=<fmt:message key='gap.message.From' bundle='${applicationMessageResources}' /> validate="isSearch">
	</td>
</tr>
</tr>
       <tr><td width="15%" align='right'><fmt:message key='gap.message.Send_time' bundle='${applicationMessageResources}' /></td><td width="30%" align="left">
...
<tr>
	...
	<td><input name="messageto" type="text" class="text_field" inputName=<fmt:message key='gap.message.Addressee' bundle='${applicationMessageResources}' /> validate="isSearch">
	</td>
</tr>
<tr>
