...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			if( o.id == undefined ) o.id = 'selectId';//马啸增加
			if( o.text == undefined ) o.name='selectText';//马啸增加
		...
		multiSelectUpdateSelected: function(o) {
			...
			if( i == 0 ) {
				...
				if( o.oneOrMoreSelected == '*' ) {
					var display = '';
					var displayValue='';//马啸增加
					$(this).find('INPUT:checkbox:checked').each( function() {
						if( $(this).parent().text() != o.selectAllText ){
							display = display + $(this).parent().text() + ', ';

							displayValue=displayValue+$(this).val() + ', ';//马啸增加
						}
					...
					$('#'+o.text).val( display );//马啸增加
					displayValue = displayValue.substr(0, displayValue.length - 2);//马啸增加
					$('#'+o.id).val( displayValue );//马啸增加
				} else {
