        ...
        .each(function() {
            ...
            if (jQuery(this).is(":has(ul)")) {
                ...
                $arrow.click(function() {
                    ...
                    if (jQuery(this).hasClass("collapsed")) {
						...
						//if (settings.onExpand) alert("expanded=");
                    }
                    else {
						...
						//if (settings.onCollapse) alert("collapsed=");
                    }
                });
            }
            ...
            $checkbox.click(function() {
                ...
                if (jQuery(this).hasClass("checked")) {
                    ...
                    if (settings.onCheck) settings.onCheck(jQuery(this).parent());//当前被选中的节点
                    
                    jQuery(this).siblings("ul").find(".checkbox").not(".checked")
                        .removeClass("half_checked")
                        .addClass("checked")
                        .each(function() {
                            if (settings.onCheck) settings.onCheck(jQuery(this).parent());//当前被选中的节点的子节点
                        })
                        .siblings(":checkbox")
                            .attr("checked", "checked")
                    ;
