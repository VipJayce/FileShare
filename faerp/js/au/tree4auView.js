...
WebFXTree.prototype.toString = function () {
	...
	str += "</td><td valign=\"bottom\" nowrap>&nbsp;<a href=\"####\" onclick=\"treeitem_Click('" + this.action + "');\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\">" + this.text + "</a></td>";
	str += "<td width=\"200\" nowrap valign=\"bottom\" align=\"center\">&nbsp;"+gap.authority.Authorization+"</td>";
	str += "</tr></table></div>";
...
function WebFXTreeItem(sText,sTitle,treeID,selCode,selTxt,selVal,selWhoEx,selWho,isDisable) {
	this._subItems  = [];
	this._wasLast   = false;
	this.text       = sText || defaultText;
...
WebFXTreeItem.prototype.toString = function (nItem,nItemCount) {
	...
	if (this.folder) {
		...
		if(this.selWho[0]=="" && this.selWho[1]=="") {
				str += gap.authority.Unauthorized;
		}else {
