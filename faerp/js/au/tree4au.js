...
WebFXTree.prototype.toString = function () {
	...
	for(var i=0; i<this.selNum; i++) {
		str += "<input type=\"Checkbox\" name=\"selectAll\" value=\""+this.selVal[i]+"\" title=\""+gap.authority.Select_All+"\" style=\"cursor:hand\" onclick=\"selAll(this);\">"+this.selTxt[i];
	}
	str +="</td></tr></table></div>";
...
WebFXTreeItem.prototype.toString = function (nItem,nItemCount) {
	...
	if (this.folder) {
		...
		for(var i=0; i<this.selNum; i++) {
			...
			str += "<input type=\"Checkbox\" name=\""+this.treeID+"\" value=\""+this.selVal[i]+"\" code=\""+this.selCode+"\" sType=\""+this.sType+"\" "+disableFlag+" title=\""+gap.authority.Hold_down_the_left_mouse_button_to_select_the_number_of_content_slide+"\" style=\"cursor:hand\" onclick=\"seltree(this);\" onmouseover=\"selNode(this)\"";
