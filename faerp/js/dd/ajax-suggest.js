...
jsAuto.prototype.append=function(msg) { with (this)
{
    ...
    //alert(msgNum);
    //var msgNum= 1;
    //if (_v)div.innerHTML = "<span class='leftspan'>" + msg2.replace(re, "<strong>$1</strong>") + "</span><span class='rightspan'>"+msgNum+"</span>";
if (_v)div.innerHTML =  msg2+msgNum;
...
jsAuto.prototype.display=function() { with(this)
{
    if(_f&&_v!="")
    {
        ...
        _o.style.left = getLeft(_r);  // 设定显示区域的位置
 ...
 with (this)
{
    ...
    {
        //下面三行注释的语句的功能是，从第一个字母匹配，匹配成功显示提示
        //if(re.test(_msg[i]))
        //{
            _i.append(_msg[i]);
            _f = true;
