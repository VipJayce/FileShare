...
*/
   dhtmlXTreeObject.prototype.insertNewItem=function(parentId,itemId,itemText,itemActionHandler,image1,image2,image3,optionStr,children){
      //alert(" parentId= "+parentId+" itemId= "+itemId+" itemText="+itemText);
...
*/
   dhtmlXTreeObject.prototype.getItemText=function(itemId)
   {
      var temp=this._globalIdStorageFind(itemId);
      /*
      alert(dwr.util.toDescriptiveString(temp.htmlNode.innerHTML,4))
      alert(dwr.util.toDescriptiveString(temp.htmlNode.childNodes[0].innerHTML,4))
      alert(dwr.util.toDescriptiveString(temp.htmlNode.childNodes[0].childNodes[0].innerHTML,4))
      alert(dwr.util.toDescriptiveString(temp.htmlNode.childNodes[0].childNodes[0].childNodes[3].innerHTML,4));
      alert(dwr.util.toDescriptiveString(temp.htmlNode.childNodes[0].childNodes[0].childNodes[3].childNodes[0],4));
      */
      if (!temp) return 0;
...
*     @topic: 6
*/
      dhtmlXTreeObject.prototype.getItemToArray=function(itemId)
   {
      var temp=this._globalIdStorageFind(itemId);
      if (!temp) return 0;
      var divObj = temp.htmlNode.childNodes[0].childNodes[0].childNodes[3].childNodes[0].childNodes[0];
      var data= new Array();
      data[0]=divObj.id;
      data[1]=divObj.innerHTML;
      return data;
   };
