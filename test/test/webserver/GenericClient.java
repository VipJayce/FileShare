...
//		try {
////			Class clazz=Class.forName("net.Server$Time");
////			Time time = (net.server.Time)clazz.newInstance();
...
////			Socket s6 = new Socket(host, port);
////			Socket s7 = new Socket(host, port);
////			Socket s8 = new Socket(host, port);
////			Socket s9 = new Socket(host, port);
...
//					// with this one.
//					to_user.println("Connection closed by server1.");
//					System.exit(0);
//				}
//			};
//
...
//
//			s.close();
//			to_user.println("Connection closed by client2.");
//			System.exit(0);
//		}
